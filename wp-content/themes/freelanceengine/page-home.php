...
global $wp_query, $ae_post_factory, $post, $user_ID; ?>
    <div class="fre-page-wrapper">
        ...
        <div class="fre-how-work">
            <div class="fre-how-work_bg hidden-xs" style="background:url(<?php if ( get_theme_mod( "img_back" ) ) {
				echo get_theme_mod( "img_back" );
			} else {
				echo get_template_directory_uri() . '/img/main_bg2.jpg';
			} ?>) top left no-repeat;"></div>
            <div class="container">
                <div class="row">

                    <div class="col-sm-12 col-md-4 col-lg-4 col-xs-12"
                         style="background:url(<?php if ( get_theme_mod( "img_back" ) ) {
						     echo get_theme_mod( "img_back" );
					     } else {
						     echo get_template_directory_uri() . '/img/main_bg2.jpg';
					     } ?>) top left no-repeat;">
                        ...
                        <div class="fre-how-work_list row">
							<?php if ( ( get_theme_mod( "desc_work_1" ) ) || ( get_theme_mod( "title_work_1" ) ) ) { ?>
                                <div class="col-sm-4 col-md-6 col-lg-6 col-xs-12">
                                    <div class="fre-how-work_list_wp">
                                        <div class="fre-how-work_list_bg"
                                             style="background:url(<?php if ( get_theme_mod( "img_work_1" ) ) {
											     echo get_theme_mod( "img_work_1" );
										     } else {
											     echo get_template_directory_uri() . '/img/work1.png';
							...
							<?php if ( ( get_theme_mod( "desc_work_2" ) ) || ( get_theme_mod( "title_work_2" ) ) ) { ?>
                                <div class="col-sm-4 col-md-6 col-lg-6 col-xs-12">
                                    <div class="fre-how-work_list_wp">
                                        <div class="fre-how-work_list_bg"
                                             style="background:url(<?php if ( get_theme_mod( "img_work_2" ) ) {
											     echo get_theme_mod( "img_work_2" );
										     } else {
											     echo get_template_directory_uri() . '/img/work2.png';
										     } ?>) center no-repeat;"></div>
							...
							<?php if ( ( get_theme_mod( "desc_work_3" ) ) || ( get_theme_mod( "title_work_3" ) ) ) { ?>
                                <div class="col-sm-4 col-md-6 col-lg-6 col-xs-12">
                                    <div class="fre-how-work_list_wp">
                                        <div class="fre-how-work_list_bg"
                                             style="background:url(<?php if ( get_theme_mod( "img_work_3" ) ) {
											     echo get_theme_mod( "img_work_3" );
										     } else {
											     echo get_template_directory_uri() . '/img/work3.png';
										     } ?>) center no-repeat;"></div>
        ...
        <div class="perfect-freelancer">
            <div class="container">
                ...
                <a class="main_bl-btn"
                   href="<?php echo bloginfo( 'url' ); ?>/register/?role=client"><?php _e( 'Hire a Pro', ET_DOMAIN ); ?></a>
            </div>
        </div>
