<?php
	 ...
	 *                          - json data id
	 */
	function ae_list_post( $post_type, $args = [] ) {
	...
	if ( ! function_exists( 'ae_comments_pagination' ) ):
		 ...
		 * @author Dakachi
		 */
		function ae_comments_pagination( $total, $current = '', $query_args = [] ) {
	...
	if ( ! function_exists( 'ae_user_pagination' ) ):
		 ...
		 * @author Dakachi
		 */
		function ae_user_pagination( $query_args = [], $total, $current = '' ) {
	...
	if ( ! function_exists( 'ae_tax_dropdown' ) ) {
		 ...
		 * @author Dakachi
		 */
		function ae_tax_dropdown( $tax, $args = [] ) {
	...
	if ( ! function_exists( 'get_the_taxonomy_list' ) ) {
		 ...
		 * @return string
		 */
		function get_the_taxonomy_list( $taxonomy = 'category', $post = '', $link_before = '', $link_after = '', $args = [] ) {
			if ( ! $post ) {
				global $post;
			}
