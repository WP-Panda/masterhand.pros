...
class AE_Wizard extends AE_Page {
	...
	public function insert_sample_data() {
		...
		$response = [ 'success' => false, 'updated_op' => get_option( 'option_sample_data' ) ];
	...
	function wizard_scripts() {
		$this->add_script( 'ae-wizard', ae_get_url() . '/assets/js/wizard.js', [
			'jquery',
			'appengine'
		] );
		wp_localize_script( 'ae-wizard', 'ae_wizard', [
            ...
            <div class="et-main-right">
                <div class="et-main-main clearfix inner-content" id="wizard-sample">
                    ...
                    <div class="desc" style="padding-top:0px;">
                        ...
                        <div class="title font-quicksand sample-title">
                            <a target="_blank"
                               href="<?php echo admin_url( 'edit.php' ); ?>"><?php _e( 'Posts', ET_DOMAIN ) ?></a>
                            <span
                ...
                <div class="et-main-main clearfix inner-content <?php if ( ! $sample_data_op ) {
                    ...
                    <div class="title font-quicksand sample-title">
                        <a href="widgets.php" target="_blank"><?php _e( 'Sidebars & Widgets', ET_DOMAIN ) ?></a>
                        <span
