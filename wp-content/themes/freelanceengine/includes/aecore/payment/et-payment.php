...
abstract class ET_Payment {
	...
	public static function get_currency_list() {
		...
		$currency = array(
			'AUD' => array(
				'code'  => 'AUD',
				'alt'   => __( "Australian Dollar", ET_DOMAIN ),
				'label' => 'AUD',
				'icon'  => 'AUD',
				'align' => 'left'
			),
			'CAD' => array(
				'code'  => 'CAD',
				'alt'   => __( "Canadian Dollar", ET_DOMAIN ),
				'label' => 'CAD',
				'icon'  => 'CAD',
				'align' => 'left'
			),
			...
			'USD' => array(
				'code'  => 'USD',
				'alt'   => __( "American Dollar", ET_DOMAIN ),
				'label' => 'USD',
				'icon'  => '$',
				'align' => 'left'
			),
			...
			'GBP' => array(
				'code'  => 'GBP',
				'alt'   => __( "British Pound", ET_DOMAIN ),
				'label' => 'GBP',
				'icon'  => '&pound;',
				'align' => 'left'
			),
			'NZD' => array(
				'code'  => 'NZD',
				'alt'   => __( "New Zealand Dollar", ET_DOMAIN ),
				'label' => 'NZD',
				'icon'  => 'NZD',
				'align' => 'left'
			),
			...
			'HKD' => array(
				'code'  => 'HKD',
				'alt'   => __( "Hong Kong Dollar", ET_DOMAIN ),
				'label' => 'HKD',
				'icon'  => 'HKD',
				'align' => 'left'
			),
			'SGD' => array(
				'code'  => 'SGD',
				'alt'   => __( "Singapore Dollar", ET_DOMAIN ),
				'label' => 'SGD',
				'icon'  => 'SGD',
				'align' => 'left'
			)
...
class ET_Paypal extends ET_Payment {
	...
	*/
	...
	public function check_ipn_response() {
		...
		$ipn_response               = ! empty( $_POST ) ? $_POST : [];
		$check_ipn_request_is_valid = $this->check_ipn_request_is_valid( $ipn_response );
		if ( $ipn_response && $check_ipn_request_is_valid ) {
	...
	public function successful_request( $posted ) {
		...
		$invoice = ! empty( $posted['invoice'] ) ? $posted['invoice'] : ( ! empty( $posted['custom'] ) ? $posted['custom'] : '' );
		if ( ! empty( $invoice ) ) {
			$order_pay = new AE_Order( $invoice );
