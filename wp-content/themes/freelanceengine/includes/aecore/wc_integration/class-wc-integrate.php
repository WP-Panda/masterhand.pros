...
class WC_Integrate {
	...
	public function add_hook() {
		...
		add_filter( 'woocommerce_order_item_needs_processing', array(
			self::getInstance(),
		...
		add_filter( 'woocommerce_register_post_type_shop_order', array(
			self::getInstance(),
			'woocommerce_register_post_type_shop_order'
		) );
		add_filter( 'woocommerce_register_post_type_shop_coupon', array(
			self::getInstance(),
