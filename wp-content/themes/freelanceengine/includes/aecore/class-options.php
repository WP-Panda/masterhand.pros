<?php
	 ...
	 * Options in this group will be stored as an array, however to get an option, use -> instead of [], since this
	 * class use __get & __set methods. This class keeps the old ways of retrieving options, so you can also use
	 * $et_{theme}_general->get_option() & update_options(), add_options()
	 *
	 * @author    AnhCV
	 * @version   1.0
	...
	if ( ! class_exists( 'AE_Options' ) ) {
		class AE_Options{
			 ...
			 * @author   Daikachi
			 */
			public function reset( $option_arr = [] ) {
