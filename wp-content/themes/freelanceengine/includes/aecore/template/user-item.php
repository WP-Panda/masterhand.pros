    ...
    <div class="et-mem-container">
        ...
        <div class="et-act">
			...
			<?php } else if ( $user_role != 'administrator' ) { ?>
                <a class="et-act-ban" href="#" data-toggle="modal" data-target="#ban_modal"
                   title="<?php _e( 'Ban this user', ET_DOMAIN ) ?>">
                    <span class="icon" data-icon="("></span>
                </a>
			<?php } ?>
            <!-- End / Ban Button -->
        ...
        <div class="et-mem-detail">
            ...
            <div class="et-mem-top">
                ...
                <span class="thread icon" data-icon="w"
                      title="<?php _e( "Posts", ET_DOMAIN ); ?>"><?php echo $user->post_count; ?></span>
                <span class="comment icon" data-icon="q"
                      title="<?php _e( "Comments", ET_DOMAIN ); ?>"><?php echo $user->comment_count; ?></span>
            </div>
