...
class AE_UsersContainer {
	...
	function render() {
		...
		?>
        <div class="et-main-content user-container" id="<?php if ( isset( $this->args['id'] ) ) {
			echo $this->args['id'];
		} ?>">
                ...
                <div id="search_users">
                    ...
                    <span class="et-search-input">
						<input type="text" class="et-input user-search" name="keyword"
                               placeholder="<?php _e( "Search users...", ET_DOMAIN ); ?>">
                    ...
                    <div class="modal-content">
                        <form id="form_ban_user" action="">
                            <div class="modal-header">
                                ...
                                <h4 class="modal-title"><?php _e( 'Ban user', ET_DOMAIN ) ?> <span
                                            class="display-name"></span></h4>
                            </div>
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-default"
                                        data-dismiss="modal"><?php _e( 'Close', ET_DOMAIN ) ?></button>
                                <button type="submit"
                                        class="btn btn-primary"><?php _e( 'Submit', ET_DOMAIN ) ?></button>
                            </div>
                        </form>
                    </div><!-- /.modal-content -->
                </div><!-- /.modal-dialog -->
        ...
        <script type="text/template" id="user-item-template">
            <div class="et-mem-container">
                ...
                <div class="et-act">
                    ...
                    <a class="et-act-unban" href="#" title="<?php _e( 'Unban this user', ET_DOMAIN ) ?>"><span
                                class="icon" data-icon=")"></span></a>
                    <# } else if ( role != 'administrator' ) { #>
                    <a class="et-act-ban" href="#" data-toggle="modal" data-target="#ban_modal"
                       title="<?php _e( 'Ban this user', ET_DOMAIN ) ?>"><span class="icon" data-icon="("></span></a>
                    <# } #>
                    <!-- End / Ban Button -->

					<?php if ( current_user_can( 'administrator' ) ) { ?>
                        <# if(register_status == "unconfirm"){ #>
                        <a class="action et-act-confirm" data-act="confirm" href="javascript:void(0)"
