	...
	function render() {
        ...
        <div class="customization-info" id="<?php echo $this->field['name']; ?> ">
            <div class="input-file upload-logo" id="<?php echo $uploaderID; ?>_container"
                 data-id="<?php echo $uploaderID; ?>" data-w="<?php echo $size[0] ?>" data-h="<?php echo $size[1] ?>">
                ...
                <span class="bg-grey-button button btn-button btn-remove-option-image"
                      id="<?php echo $uploaderID . ''; ?>_remove_button"
                      style="height:50px;margin-top:10px; margin-left:10px; display:none"
                      data-id="<?php echo $attach_id ?>" data-name="<?php echo $uploaderID; ?>">
