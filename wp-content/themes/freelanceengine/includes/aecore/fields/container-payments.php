...
class AE_OrderList {
        ...
        <div class="et-main-content order-container" id="">
            <div class="search-box et-member-search">
				...
				<span class="et-search-role">
					...
					<input type="text" class="et-input order-search" name="keyword"
                           placeholder="<?php _e( "Search post...", ET_DOMAIN ); ?>">
	...
	function fetch_orders() {
		...
		if ( ! $orders->have_posts() ) {
			$response['msg'] = __( "No order found by your query.", ET_DOMAIN );
		}
