	...
	function render() {
        ...
        <ul class="list-language">
			<?php foreach ( $langArr as $value ) { ?>
                <li>
                    <a class="<?php if ( $selected_lang == $value )
						echo "active" ?>" title="<?php echo $value ?>" href="#et-change-language"
                       rel="<?php echo $value ?>"><?php echo $value ?> </a>
                </li>
			<?php } ?>
            <li class="new-language">
                <button class="add-lang"><?php _e( 'Add a new language', ET_DOMAIN ) ?><span class="icon"
                                                                                             data-icon="+"></span>
                </button>
                <div class="lang-field-wrap">
                    <input id="" type="text" placeholder="<?php _e( "Enter language name", ET_DOMAIN ) ?>"
                           name="lang_name" class="input-new-lang">
                </div>
            </li>
        </ul>
            ...
            <div class="show-new-language">
                <div class="item form no-background no-padding no-margin">
                    <div class="form-item form-item-short">
                        ...
                        <input id="new-language-name" class="bg-grey-input" type="text"
                               placeholder="<?php _e( "Enter the language's name", ET_DOMAIN ) ?>"/>
                        <button id="add-new-language"><?php _e( 'Add language', ET_DOMAIN ) ?><span class="icon"
                                                                                                    data-icon="+"></span>
                        </button>
