                ...
                array(
                    ...
                    'fields' => array(
                        array(
                            ...
                            'text' => __("Email templates for Get/Request Quote process. You can use placeholders to include some specific content.", ET_DOMAIN)
                                . '<a class="icon btn-template-help payment" data-icon="?" href="#" title="View more details"></a>'
                                . '<div class="cont-template-help get-quote-setting">'
                                    . '[message],[display_name],[user_email] : ' . __("shortcodes mail \"Qet Quote\" that you can send mail", ET_DOMAIN)
                                . '</div>'
                                . '<div class="cont-template-help get-quote-setting">'
                                . '[project_link],[project_name],[display_name],[user_email] : ' . __("shortcodes mail \"Request Quote Company\" that you can send mail", ET_DOMAIN)
                                . '</div>',
