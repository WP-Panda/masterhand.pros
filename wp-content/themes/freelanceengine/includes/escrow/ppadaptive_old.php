...
//        ActivityRating\Log::getInstance()->addLog('PPAdaptive', ['$paykey' => $paykey]);
...
//        ActivityRating\Log::getInstance()->addLog('PPAdaptive', ['resp' => $a]);
//        ActivityRating\Log::getInstance()->save();
        if(!is_wp_error( $a )) {
            return json_decode($a['body']);
        }
        return array('success' => false, 'msg' => $a->get_error_message());
