...
function project_category_template_include($template){
    if(strpos($_SERVER['REQUEST_URI'], '/project_category') !== false){
        ...
        add_filter( 'body_class', function( $classes ) { return array_merge( $classes, array( 'page-template-page-projects page' ) );} );
        status_header(200);
...
//*********************** NOT USED ******************
        ...
        //new2
        $arr = array('country' => $result->country, 'state' => $result->state, 'city' => $result->city);
