<?php
	function fre_register_company() {
		...
		$ae_post_factory->set( COMPANY, new AE_Posts( COMPANY, [ 'project_category' ], [
			'country',
			'state',
			'city'
		] ) );
					...
					<?php
						...
						foreach ( $subNames as $sub ): ?>
                            <option selected="selected"
                                    value="<?php echo $sub[ 0 ][ 'term_id' ] ?>"><?php echo $sub[ 0 ][ 'name' ] ?></option>
						<?php endforeach; ?>
                    ...
                    <form method="post">
                        ...
                        <select class="countries" name="<?php echo $field_name ?>">
							...
							<?php foreach ( $results_countries as $country ) { ?>
                                <option name=""
                                        value="<?php echo $country->name; ?>"><?php echo $country->name; ?></option>
							<?php } ?>
                        </select>
                    </form>
                </div>
