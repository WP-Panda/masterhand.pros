...
<div class="fre-page-wrapper">
    <div class="how_bl trust-list">
        <div class="top-page">
            <div class="visible-lg visible-md"><?php the_post_thumbnail('original');?></div>
            <h1><?php _e('Trust & safety', ET_DOMAIN)?></h1>
        </div>
            <div class="container">
                <div class="cats-list">
                    <?php if(!empty($pages)) {?>
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-md-3 col-lg-3 col-xs-12">
                            <div class="profs-cat-list_t text-center <?php if ($pages__value->ID == $pid ) { echo 'active-menu-item'; }?>">
                    ...
                    <div class="how_bl-list">       
                        ...
                        <div class="how_bl-list-item">
                            ...
                            <div class="how_bl-bg hidden-xs">
                                <img src="<?php the_sub_field('block-image');?>" alt="<?php strip_tags(the_sub_field('block-header'));?>" />
                            </div>
                            <?php }?>
                            <div class="container">
                                <div class="how_bl-list-item-wp">
                                    <div class="profs-cat_t"><span><?php the_sub_field('block-header');?></span></div>
                ...
                <div class="faq_bl">
                    ...
                    <div class="fre-page-title">
                        <div class="profs-cat_t">
                            <h6><span><?php the_sub_field('block-header');?></span></h6>
                        </div>
                    </div>
                    <?php }?>
                    <div class="questions-list">
                        <?php $q = 0; while( have_rows('question-list') ): the_row(); ?>
                        <div class="questions-list_item">
                            <div class="questions-list_t" data-toggle="collapse" data-target="#bl-<?php echo $n2;?>-q-<?php echo $q;?>">
