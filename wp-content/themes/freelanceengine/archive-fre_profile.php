               ...
               <div class="row">
                   ...
                   <div class="col-sm-6 hidden-xs">
                        <div class="profs-cat_desc">
                            <a class="profs-cat_link" href="<?php echo get_option('siteurl') . '/profile_category';?>">
                                        ...
                                        <div class="col-lg-4 col-lg-push-8 col-md-6 col-md-push-6 col-sm-6 col-sm-push-6 hidden-xs">
											<?php if ( $query_post >= 1 ) { ?>
                                                <div id="profile_orderby" class="fre-profile-sort">
                                                    ...
                                                    <span class="option" id="hour_rate"><?php _e( 'Price', ET_DOMAIN ); ?></span>
                                                    <span class="option" id="rating"><?php _e( 'Ranking', ET_DOMAIN ); ?></span>
                                                    <span class="option" id="projects_worked"><?php _e( 'Projects', ET_DOMAIN ); ?></span>
                                                </div>
