    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-6 hidden-xs">
                <p class="text-copyright"><?php if ( $copyright ) { echo $copyright;} else { echo 'All rights reserved.';}?></p>
            </div>
...
if (
    (is_page_template('page-edit-project.php')) ||
    (is_page_template('page-submit-project.php')) ||
    (is_page_template('page-options-project.php')) ||
            ...
            <div class="modal-body">
                <form role="form" id="quit_project_form" class="quit_project_form fre-modal-form">
                    ...
                    <div class="fre-form-btn">
                        ...
                        <span class="fre-form-close fre-cancel-btn " data-dismiss="modal"><?php _e('Cancel', ET_DOMAIN); ?></span>
                    </div>
                </form>
            </div>
        </div><!-- /.modal-content -->
