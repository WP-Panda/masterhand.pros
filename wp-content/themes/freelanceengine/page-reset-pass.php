                    ...
                    <div class="fre-authen-reset-pass">
                        ...
                        <form role="form" id="resetpass_form" class="signin_form">
                            ...
                            <div class="fre-input-field">
                                <input type="password" class="need_valid" name="new_password" id="new_password" placeholder="<?php _e('New Password', ET_DOMAIN);?>">
                            </div>
                            <div class="fre-input-field">
                                <input type="password" class="need_valid" id="re_new_password" name="re_new_password" placeholder="<?php _e('New Password Confirm', ET_DOMAIN);?>">
                            </div>
