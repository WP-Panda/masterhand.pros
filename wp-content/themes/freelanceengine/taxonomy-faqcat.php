...
$terms2 = get_terms(array('taxonomy'=>$taxonomy, 'hide_empty'  => 0, 'parent' => $termParents->term_id));
                            ...
                            <div class="fre-profile-box">
                                <ul class="help-list">
                                    <?php foreach ($terms2 as $termParent) {
                                        ...
                                        ?>
                                        <li class="help-item <?php echo $class ?>"><a href="<?php echo $termLink ?>" class="help-link"><?php echo $termParent->name?></a></li>
                                    <?php }?>
                                </ul>
                            </div>
                        </div><!-- #primary-sidebar -->
                            ...
                            if($partnersList->have_posts()) {
                                while($partnersList->have_posts()) {
                                    ...
                                    <li class="help-sub_menu__item">
                                        <a class="help-sub_menu__link" href="<?php the_permalink(); ?>"><?php the_title();?></a>
                                    </li>
