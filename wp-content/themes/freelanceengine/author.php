...
<div class="fre-page-wrapper list-profile-wrapper" <?=$style?>>
    ...
    <div class="container">
            ...
            <div class="author-freelance-wrap">
                        ...
                        <div class="profile-freelance-info top row">
                                ...
                                <div class="col-sm-8 col-xs-12 freelance-name">
                                    ...
                                    <?php if ($visualFlag) {
                                            switch ($visualFlagNumber){
                                                case 1: echo '<span class="status">' . translate('Master', ET_DOMAIN) . '</span>'; break;
                                                case 2: echo '<span class="status">' . translate('Creator', ET_DOMAIN) . '</span>'; break;
                                                case 3: echo '<span class="status">' . translate('Expert', ET_DOMAIN) . '</span>'; break;
                                            }
                                        } ?>
                                </div>
                            ...
                            <div class="col-sm-3 col-xs-12">
                                ...
                                <div class="secure-deals">
                                    ...
                                    <span><?= ($safe_deals_count == '')? 0 : $safe_deals_count?></span>
                                </div>
                                <div class="reviews">
                ...
                <div class="fre-profile-box skills_awards_wp">
                    <div class="row skills_awards">
                        <div class="col-sm-12 col-xs-12 skill-list"><!-- пока нет наград - ставим 12 вместо col-sm-6-->
                            <div class="bl_t">
                ...
                <div class="row info_bl">
                    <div class="col-sm-7 col-md-8 col-lg-9 col-xs-12 fre-profile-box">
                        ...
                        <div class="hidden freelance-about hidden-contacts">
                            ...
                            <p>
                                <?php if ($user_data->user_email) { _e('<strong>Email:</strong>', ET_DOMAIN); echo $user_data->user_email; }?></p>
                            <p>
                                <?php if ($user_data->user_phone) { _e('<strong>Phone:</strong>', ET_DOMAIN); echo $user_data->user_phone; }?></p>
                            <?php if ($fb) { ?>
                            <p><a href="<?php echo $fb; ?>" target="_blank" rel="nofollow"><?php echo $fb; ?></a></p>
                            <?php }
                                        if ($skype) { ?>
                            <p><?php echo $skype; ?></p>
                            <?php }
                            ...
                            <?php }
                                        if ($ln) { ?>
                            <p><a href="<?php echo $ln; ?>" target="_blank" rel="nofollow"><?php echo $ln; ?></a></p>
                            <?php } ?>
                        </div>
                    ...
                    <div class="col-sm-5 col-md-4 col-lg-3 col-xs-12">
                        ...
                        <div class="freelance-hourly">
                            <?php if (fre_share_role() || $isFreelancer) { if ($hour_rate > 0) {?>
                            ...
                            <div class="freelance-info-edit">
                                ...
                                <a href="#" class="fre-submit-btn btn-center <?php if (is_user_logged_in()) {
                                                       echo 'invite-open';
                                                   } else {
                                                       echo 'login-btn';
                                ...
                                <a href="<?php if($user_ID == 0){ echo et_get_page_link( "login" );} else{ echo '#';} ?>" class="<?php if($user_ID == 0){ echo 'fre-submit-btn btn-center';} else{ echo 'fre-submit-btn btn-center contact-me';} ?>" data-user="<?php if($user_ID != 0){ echo $convert->post_author;}  ?>">
                                ...
                                <a href="<?php if($user_ID == 0){ echo et_get_page_link( "login" );} else{ echo '#';} ?>" class="<?php if($user_ID == 0){ echo 'fre-submit-btn btn-center';} else{ echo 'fre-submit-btn btn-center info-open';} ?>" data-user="<?php if($user_ID != 0){ echo $convert->post_author;} ?>">
        ...
        <ul class="nav nav-justify-content-center" id="Tabs" role="tablist">
            <?php if (fre_share_role() || $isFreelancer) {?>
            <li class="nav-item">
                <a class="nav-link active" id="portfolio-tab" data-toggle="tab" href="#portfolio" role="tab" aria-controls="portfolio" aria-selected="true">
                    <?php echo __("Portfolio", ET_DOMAIN); ?>
                </a>
            </li>
            <?php } else {?>
            <li class="nav-item">
                <a class="nav-link active" id="projects-tab" data-toggle="tab" href="#projects" role="tab" aria-controls="projects" aria-selected="false">
        ...
        <div class="tab-content" id="TabsContent">
            ...
            <div class="tab-pane fade in active" id="projects" role="tabpanel" aria-labelledby="projects-tab">
                ...
                <ul class="fre-tabs nav-tabs-my-work">
                    <li class="active"><a data-toggle="tab" href="#all-project-tab"><span><?php _e('All', ET_DOMAIN); ?></span></a>
                    </li>
                    <li class="next"><a data-toggle="tab" href="#open-project-tab"><span><?php _e('Open', ET_DOMAIN); ?></span></a>
                    </li>
                    <li class="next"><a data-toggle="tab" href="#closed-project-tab"><span><?php _e('Closed', ET_DOMAIN); ?></span></a>
                    </li>
                </ul>
                <div class="fre-tab-content projects-tab">
                    ...
                    <div id="all-project-tab" class="employer-current-project-tab fre-panel-tab active">
                        <?php $employer_current_project_query = new WP_Query(
                         ...
                         <div class="current-employer-project">
                             ...
                             <?php } else { _e('No results', ET_DOMAIN);}?>
                    ...
                    <div id="closed-project-tab" class="employer-previous-project-tab fre-panel-tab">
                        <?php $employer_closed_project_query = new WP_Query(
                                    array(
                                        'post_status' => array('complete', 'close', 'disputing', 'archive'),
                                        'is_author' => true,
                                        'post_type' => PROJECT,
                                        'author' => $author_id,
                                        'suppress_filters' => true,
