...
;(function (e, t) {
    ...
    var r = function (r, i) {
        var i = e.extend({}, n, i), s = e("body"), o = e(r);
        var u = '<div id="tubular-container" style="width: 100%; height: 100%"><div id="tubular-player" style="position: absolute"></div></div><div id="tubular-shield" style="width: 100%; height: 100%; z-index: 2; position: absolute; left: 0; top: 0;"></div>';
        e("html,body").css({width: "100%", height: "100%"});
        o.prepend(u);
        o.css({position: "relative", "z-index": i.wrapperZIndex, overflow: "hidden"});
        t.player;
        ...
        var a = function () {
            var n = e(t).width(), r, s = e(t).height(), o, u = e("#tubular-player");
            if (n / i.ratio < s) {
                r = Math.ceil(s * i.ratio);
                u.width(r).height(s).css({left: (n - r) / 2, top: 0})
            } else {
                o = Math.ceil(n / i.ratio);
                u.width(n).height(o).css({left: 0, top: (s - o) / 2})
            }
        };
