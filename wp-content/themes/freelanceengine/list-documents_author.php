...
if ( ! empty( $documents_id ) ) { ?>
    <div class="fre-profile-box documents_page">
		...
		<?php } else { ?>
            <ul class="freelance-portfolio-list row">
				...
				foreach ( $documents_id as $item ) {
                    ...
                    <li class="col-sm-4 col-md-3 col-lg-3 col-sx-12">
                        ...
                        <div class="freelance-portfolio-wrap"
                             id="portfolio_item_<?php echo $document['id'] ?>"
                            ...
                            <p class="portfolio-action">
								...
								<?php } else { ?>
                                    <a href="#modal_show_file" data-toggle="modal"
                                       class="fre-submit-btn btn-center"
            ...
            <div class="modal" id="modal_delete_file" role="dialog" aria-labelledby="myModalLabel"
                 aria-hidden="true">
