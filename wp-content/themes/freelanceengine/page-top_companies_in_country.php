<?php
/**
 * Template Name: Top companies in country
...
/* Настройка:
1. перейти "Custom Fields"-"Add New"
    2.1 "Add title" = "Country for pages - Top companies by country"
    2.2 создать "+ Add Field" со значениями:
        "Field Label" = company in country
        "Field Name" = company_in_country
        "Field Type" = Select
        "Choices"=  Australia
                    Canada
                    ...
                    New Zealand
                    United States : USA
        "Required?", "Stylised UI", "Use AJAX to lazy load choices?" = Yes

    2.3 выбрать "Rules": Post Template = "Top companies in country"
2. создать старницы с шаблоном "Top companies in country" в параметре "company in country" выбрать страну
3. создать меню "Footer company", добавить соответствующие страницы
4. В "Widgets" - "Top companies footer" указать "title" и "Select Menu:" = "Footer company"
*/
...
?>
    ...
    <div class="fre-page-wrapper section-archive-company">
        <div class="fre-page-title profs-cat">
            <div class="container">
                <div class="row">
                    <div class="col-sm-6 col-xs-12">
                        <div class="profs-cat_t">
                            <h1><?php _e('Companies', ET_DOMAIN); ?></h1>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="page-profile-list-wrap">
                    <div class="fre-profile-list-wrap">
                        <?php get_template_part('template/filter', 'companies'); ?>
                        <div class="fre-company-list-box">
                            <div class="fre-profile-result-sort">
                                <div class="row">
                                    <?php
                                    $found_posts = '<span class="found_post">' . $col_posts . '</span>';
                                    $plural = sprintf(__('%s companies available', ET_DOMAIN), $found_posts);
                                    $singular = sprintf(__('%s company available', ET_DOMAIN), $found_posts);
                                    $not_found = sprintf(__('There are no companies on this site!', ET_DOMAIN), $found_posts);
                                    ?>
                                    ...
                                    <div class="col-lg-8 col-lg-pull-4 col-md-6 col-md-pull-6 col-sm-6 col-sm-pull-6 col-xs-12">
                                        <div class="fre-profile-result">
                                            ...
                                            <span class="singular <?php if ($col_posts > 1 || $col_posts < 1) {
                                                echo 'hide';
                            ...
                            <?php get_template_part('list', 'companies'); ?>
                        </div>
                    </div>
                    <?php
