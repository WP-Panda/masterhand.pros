                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-xs-12">
                            <div class="masterhan-create-wrap">
                                ...
                                <a href="<?php echo bloginfo('url');?>/register/?role=client" class="fre-submit-btn masterhan-create__link"><?php echo _('SIGN UP AS A CLIENT')?></a>
                            </div>
                ...
                <div class="masterhand-sign-up">
                    <div class="sign-up-wrap">
                        ...
                        <div class="sign-up__link">
                            <a class="fre-submit-btn" href="<?php echo bloginfo('url');?>/register/?role=client"><?php echo _('SIGN UP AS A CLIENT');?></a>
                        </div>
            ...
            <div id="if-pro" class="tab-pane fade">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-xs-12">
                            <div class="masterhan-create-wrap">
                                ...
                                <a href="<?php echo bloginfo('url');?>/register/?role=professional" class="fre-submit-btn masterhan-create__link"><?php echo _('SIGN UP AS A PRO')?></a>
                            </div>
                ...
                <div class="masterhand-sign-up">
                    <div class="sign-up-wrap">
                        ...
                        <?php } ?>
                        <div class="sign-up__link">
                            <a class="fre-submit-btn" href="<?php echo bloginfo('url');?>/register/?role=professional"><?php echo _('SIGN UP AS A PRO');?></a>
                        </div>
