                ...
                <ol class="row">
                    ...
                    <li class="col-sm-4 col-xs-12">
                        <img src="/wp-content/plugins/generate_banner/template/banner1.png" alt="bn1"
                             width="250px">
                        <button class="getImgBtn fre-submit-btn btn-center" data-name="banner1"><?php _e('GENERATE PERSONAL BANNER');?></button>
                        <div style="">
                    ...
                    <li class="col-sm-4 col-xs-12">
                        <img src="/wp-content/plugins/generate_banner/template/banner2.png" alt="bnr2"
                             width="250px">
                        <button class="getImgBtn fre-submit-btn btn-center" data-name="banner2"><?php _e('GENERATE PERSONAL BANNER');?></button>
                        <div style="">
                      ...
                      <li class="col-sm-4 col-xs-12">
                        <img src="/wp-content/plugins/generate_banner/template/banner3.png" alt="bnr3"
                             width="250px">
                        <button class="getImgBtn fre-submit-btn btn-center" data-name="banner3"><?php _e('GENERATE PERSONAL BANNER');?></button>
                        <div style="">
                    ...
                    <?php } else {?>
                        <li class="col-sm-4 col-xs-12">
                            <img src="/wp-content/plugins/generate_banner/template/banner4.png" alt="bn4"
                                 width="250px">
                            <button class="getImgBtn fre-submit-btn btn-center" data-name="banner4"><?php _e('GENERATE PERSONAL BANNER');?></button>
                            <div style="">
                        ...
                        <li class="col-sm-4 col-xs-12">
                            <img src="/wp-content/plugins/generate_banner/template/banner5.png" alt="bnr5"
                                 width="250px">
                            <button class="getImgBtn fre-submit-btn btn-center" data-name="banner5"><?php _e('GENERATE PERSONAL BANNER');?></button>
                            <div style="">
                          ...
                          <li class="col-sm-4 col-xs-12">
                            <img src="/wp-content/plugins/generate_banner/template/banner6.png" alt="bnr6"
                                 width="250px">
                            <button class="getImgBtn fre-submit-btn btn-center" data-name="banner6"><?php _e('GENERATE PERSONAL BANNER');?></button>
                            <div style="">
                    ...
                    <ol class="row">
                        ...
                        <li class="col-sm-4 col-xs-12">
                            <img src="/wp-content/plugins/generate_poster/template/assets/poster3.png" alt="poster3"
                                 width="250px">
                            <button class="generate fre-submit-btn btn-center" onclick="generate_poster_ajax('print', 'poster3')">print</button>
                            <p><?php _e("or", ET_DOMAIN) ?></p>
                            <button class="generate fre-submit-btn btn-center" onclick="generate_poster_ajax('show', 'poster3')">download</button>
                        </li>
                        <li class="col-sm-4 col-xs-12">
                        ...
                        foreach ($referrals as $item) {
                            $profile_id = get_user_meta($item['user_id'], 'user_profile_id', true); ?>
                                <div class="page-referrals_item">
                                    ...
                                    <a class="name" href="<?= '/author/' . $item['user_login'] ?>"><?= $item['user_name'] ?></a>
                                    <span class="status">
