...
<div class="fre-page-section">
    <div class="container">
        <div class="page-post-project-wrap" id="post-place">
            ...
            <div id="fre-post-project-3 step-payment" class="fre-post-project-step step-wrapper step-payment" style="display: block; margin: 100px 0;">
                        ...
                        <ul id="fre-payment-accordion" class="fre-payment-list panel-group">
                            ...
                            if ($paypal['enable']) { ?>
                                <li class="panel">
                                    ...
                                    <form method="post" class="<?=$paymentType == 'review' ? 'review-payment__form' : 'order-payment__form'?>" action="<?=$urlRequest;?>">
                                        ...
                                        <input type="hidden" name="item_name" value="<?=$_POST['plan_name']?>">
                                    ...
                                    <a data-toggle="collapse" data-parent="#fre-payment-accordion" href="#fre-payment-paypal" class="btn-left collapsed select-payment fre-submit-btn" data-type="paypal"><?php _e("Pay with PayPal", ET_DOMAIN); ?></a>
                                </li>
                            <?php } ?>
                            ...
                            if ($cash['enable']) { ?>
                                <li class="panel">
                                    ...
                                    <a data-toggle="collapse" data-type="cash" data-parent="#fre-payment-accordion" href="#fre-payment-cash" class="btn-left collapsed fre-submit-btn other-payment"><?php _e("Select", ET_DOMAIN); ?></a>
                            ...
                            if ($co['enable']) { ?>
                                <li class="panel">
                                    ...
                                    <a href="#" class="btn-left collapsed btn-submit-price-plan fre-submit-btn select-payment" data-type="2checkout"><?php _e("Pay with a card", ET_DOMAIN); ?></a>
                                </li>
                            <?php } ?>
