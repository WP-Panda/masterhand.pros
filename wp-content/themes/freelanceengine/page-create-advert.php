...
<div class="fre-page-wrapper">
    ...
    <? if($limitAdverts == 0){ ?>
                <div class="fre-post-project-box">
                    <a href="/pro" class="go-to-pro-account"><? _e('Activate Account Pro for Creating Special Offers') ?></a>
                </div>
    <? } else { ?>
	<div class="fre-post-project-box">
		<div>
		...
		if($totalLeft > 0) {
			...
			<form id="create-ad" class="" role="form" method="POST" onsubmit="return false;">
				...
				<div class="fre-post-project-btn">
                    ...
                    <button class="fre-cancel-btn" onclick="history.back(-1)" type="cancel"><?php _e("Cancel", ET_DOMAIN); ?></button>							
				</div>
			</form>
			</div>
			<style>
