                ...
                <div class="col-lg-4 col-md-5">
					...
					<?php if ( current_user_can( 'manage_options' ) && $post->post_status != 'disputed' ) { ?>
                        <div class="project-detail-action">
                            <a class="fre-normal-btn btn-arbitrate-project" id="<?php echo $project->ID ?>" data-bid-price="<?php echo $bid_budget; ?>"
                    ...
                    <?php if ($can_comment == "both" && $role == FREELANCER && !$is_comment_exist || $can_comment == "freelancer" && $role == FREELANCER && !$is_comment_exist):?>
                        <div class="project-detail-action">
                            <a href="#" id="<?php the_ID(); ?>" class="fre-normal-btn fre-submit-btn btn-complete-project"> <?php _e( 'Review for Client', ET_DOMAIN ); ?></a>
                        </div>
                    <?php elseif ($can_comment == "both" && $role == EMPLOYER && !$is_comment_exist || $can_comment == "employer" && $role == EMPLOYER && !$is_comment_exist):?>
                        <div class="project-detail-action">
                            <a href="#" id="<?php the_ID(); ?>" class="fre-normal-btn fre-submit-btn btn-complete-project"> <?php _e( 'Review for Professional', ET_DOMAIN ); ?></a>
                        </div>
                    <?php endif;?>
