            ...
            <div class="step-post-project" id="fre-post-project">
                ...
                <div class="fre-input-field">
                    ...
                    <div class="fre-project-budgets">
                        ...
                        <input id="project-budget" type="number" placeholder="1" class="input-item text-field is_number numberVal" pattern="-?(\d+|\d+.\d+|.\d+)([eE][-+]?\d+)?" onkeydown="if (event.keyCode == 16 || event.keyCode == 69 || event.keyCode == 189) return false" name="et_budget" min="1">
                ...
                <div class="fre-input-field">
                    ...
                    <div>
                        ...
                        <div class="fre-input-field select">
                            ...
                            <select name="country" id="country" data-selected_id="<?= !empty($location['country']['id']) ? $location['country']['id'] : '' ?>"  data_user_country_id="<?= !empty($location['country']['id']) ? $location['country']['id'] : '' ?>">
                                ...
                                <?php if ($query_country->num_rows > 0) {
                                    ...
                                    while ($row = $query_country->fetch_assoc()) {
                                        ...
                                        if (!empty($location['country']) && $location['country']['id'] == $row['id']) $flag = 'selected';
