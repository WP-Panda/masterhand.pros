        ...
        <div class="fre-input-field">
            <div class="checkline">
                <input id="<?php echo $item['sku'] ?>"
                       ...
                       <?php if ($item['sku'] == 'create_project_for_all') { echo 'value="5" checked="checked"'; } else { echo 'value="1"';}?>>
                <label for="<?php echo $item['sku'] ?>" <?php if ($item['sku'] == 'create_project_for_all') { echo 'class="active"';} ?>><?= getNameByProperty($item['sku']); ?></label>
