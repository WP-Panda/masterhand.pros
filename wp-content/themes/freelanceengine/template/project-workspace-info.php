...
<div class="project-detail-box">
    <div class="project-employer-review">
        ...
        <p><a href="<?php echo $convert->author_url; ?>" class="review-author-name" target="_blank"><?php echo $convert->author_name; ?></a></p>
        ...
        <?php if ( empty( $review_for_employer ) ){ ?>
            <a href="#" id="<?php the_ID(); ?>" class="fre-normal-btn fre-submit-btn btn-complete-project btn-review-for-client"> <?php _e( 'Review for Client', ET_DOMAIN ); ?></a>
        <?php } ?>
        ...
        <?php
            ...
            <div class="showed-review">
                <a href="#" data-review_id="<?=$review_for_freelancer['id'] ?>" class="review-must-paid fre-submit-btn fre-normal-btn"><?php _e('Showed', ET_DOMAIN); ?></a>
            </div>
...
<div class="project-detail-box" style="display:flex">
    <div class="project-employer-review">
        ...
        <p><a href="<?php echo $freelancer_data->author_url; ?>" class="review-author-name" target="_blank"><?php echo $freelancer_data->display_name; ?></a>
        </p>
        ...
        <div class="row">
            <div class="col-lg-8 col-md-7 col-sm-12 col-xs-12">
                ...
                <ul class="project-bid-info-list">
                    <li>
                        ...
                        <a href="<?php echo $convert->author_url; ?>" target="_blank"><?php echo $convert->author_name; ?></a>
                        <?php } else if ( ( fre_share_role() || $role !== FREELANCER ) && $user_ID == $project->post_author ) { ?>
                        <span><?php _e( 'Professional', ET_DOMAIN ); ?></span>
                        <a href="<?php echo $freelancer_data->author_url; ?>" target="_blank"><?php echo the_author_meta( 'display_name', $profile_id ); ?></a>
                        <?php } ?>
                    </li>
                    <li>
            ...
            <div class="col-lg-4 col-md-5  col-sm-12 col-xs-12">
                ...
                <div class="project-detail-action workspace-actions">
                    ...
                    <a title="<?php _e( 'Finish', ET_DOMAIN ); ?>" href="#" id="<?php the_ID(); ?>" class="fre-submit-btn btn-left btn-complete-project"> <?php _e( 'Finish', ET_DOMAIN ); ?></a>
                    <?php if ( ae_get_option( 'use_escrow' ) ) { ?>
                    <a title="<?php _e( 'Discontinue', ET_DOMAIN ); ?>" href="#" id="<?php the_ID(); ?>" class="fre-submit-btn btn-right btn-close-project"><?php _e( 'Discontinue', ET_DOMAIN ); ?></a>
                    <?php }
						} else {
							if ( $bid_accepted_author == $user_ID && ae_get_option( 'use_escrow' ) ) { ?>
                    <a title="<?php _e( 'Discontinue', ET_DOMAIN ); ?>" href="#" id="<?php the_ID(); ?>" class="fre-submit-btn btn-right btn-quit-project"><?php _e( 'Discontinue', ET_DOMAIN ); ?></a>
                    <?php }
						}
