...
$endorse_text = ! empty( WPP_Skills_User::getInstance()->is_emdorsment( $postid ) ) ? 'Endorsed' : 'Not Endorsed';
?>
<div class="page-referrals_item">
    <div class="row">
        <div class="col-sm-6 col-xs-5">
            <a class="hidden-xs" href="<?php the_permalink(); ?>">
				<?php echo get_avatar( $postid, 70 ); ?>
            </a>
