        ...
        <div class="step-post-package">
            <ul class="row fre-post-package">
                <?php foreach ($packs as $key => $package) {
                    ...
                    ?>
                <li class="col-sm-4 col-xs-12 <?php echo $class_select; ?> <?php echo $disabled; ?>" data-sku="<?php echo trim($package->sku); ?>" data-id="<?php echo $package->ID ?>" data-price="<?php echo $package->et_price; ?>" data-package-type="<?php echo $package->post_type; ?>" data-title="<?php echo $package->post_title; ?>" data-description="<?#php echo $text; ?>">
            ...
            <div class="hidden">
                <input class="fre-btn fre-post-project-next-btn select-plan" type="button" value="<?php _e('Choose a plan', ET_DOMAIN); ?>">
            </div>
        </div>
    </div>