    ...
    <div class="project-content fre-freelancer-wrap">
        <? if($current->button) {?>
            <div class="fre-input-field" style="float:right;">
                <div class="checkline">
                    <input class="get-quote-company" name="company_checked" type="checkbox" data-id="<?=$current->ID?>" data-name="<?=$current->post_title?>">
        ...
        <div class="project-list-info project-list-adres">
            ...
            <? if($current->button) {?>
                <span class="company-item_btn" data-id="<?=$current->ID?>" data-name="<?=$current->post_title?>"><?=$current->button;?></span>
            <? } else { ?>
                <span class="company-item_btn"><a href="/login" class="btn-get-quote-to-login"><? _e('Get a Quote'); ?></a></span>
            <? } ?>
        </div>
    </div>
</li>
