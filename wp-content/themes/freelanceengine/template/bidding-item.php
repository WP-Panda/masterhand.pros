...
<div class="row freelancer-bidding-item <? if ($user_ID == $convert->post_author) { ?>user-bid<? } ?>"
     style="
        ...
        <?php if (!empty($convert->bid_background_color)) { echo "background: #{$convert->bid_background_color}"; } ?>
     ">
                ...
                <div class="fre-freelancer-wrap col-free-bidding">
                    ...
                    <div class="name">
                        ...
                        <?php if ($conversation_exists){ ?>
                            <a class="fre-notification__link" href="/private-message/?pr_msg_c_id=<?=$conversation_id?>">
                                <img src="<?php echo get_template_directory_uri()?>/img/mail.svg" class="fre-notification__mail-icon <?php if (!$conversation_has_read){ ?>fre-notification__mail-icon--unread<? } ?>">
                                <?php if (!$conversation_has_read){ ?><span class="fre-notification__circle-icon"></span><?php } ?>
                            </a>
                        <?php } ?>
                    </div>
                    ...
                    <div class="hidden-xs client-bid-btns col-content-bid-<?php echo $convert->ID ?>">
                        ...
                        if ($user_ID == $post->post_author){
                            ...
                            ?>
                            <a class="fre-action-btn fre-submit-btn btn-right bid-action" data-action="edit" data-bid-id="<?php echo $post->ID?>">
