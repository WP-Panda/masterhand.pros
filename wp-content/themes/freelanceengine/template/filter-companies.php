                ...
                <div class="col-md-4">
                    <div class="fre-input-field">
                        ...
                        <?php ae_tax_dropdown('project_category', array(
                                'attr' => 'data-selected_slug="'.$category_company_selected.'"',//'data-chosen-width="100%" data-chosen-disable-search="" data-placeholder="' . __("Select cat", ET_DOMAIN) . '"',
                    ...
                    <div class="fre-input-field">
                        <label for="sub"
                               class="fre-field-title"><?php _e('Subcategory', ET_DOMAIN); ?></label>
                                <div class="select_style">
                                    <select name="sub" id="sub" data-selected_slug="<?= $subcategory_company_selected?>">
