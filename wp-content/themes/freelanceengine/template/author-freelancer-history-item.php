            ...
            <?php if ( $role == EMPLOYER && !empty( $review_for_employer['comment'] ) ) { ?>
                <div class="project-detail-box">
                    ...
                    <?php if ($today < $reply_deadline && empty($reply_to_review)){ ?>
                        <a title="Reply to review" href="#" data-review_id="<?=$review_for_freelancer['id']?>" id="<?=$review_for_freelancer['id']?>" class="fre-submit-btn btn-left project-employer__reply project-employer_reply_history  main_bl-btn"><?php _e( 'Reply to review', ET_DOMAIN ); ?></a>
                    <?php } ?>
                </div>
            <?php } ?>
        </div>
