    ...
    <div class="profile-content">
        <ul class="top-profile">
            ...
            <li class="info-profile">
                ...
                <span class="position-profile"
                      title="<?php echo $current->et_professional_title; ?>"><?php echo $current->et_professional_title; ?></span>
            </li>
            <li class="link-profile">
                <a href="<?php echo $current->permalink; ?>" class="btn btn-view-profile"
