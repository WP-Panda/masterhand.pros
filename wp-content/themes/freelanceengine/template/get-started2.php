<div class="get-started-content">
	<?php if(!is_user_logged_in()){ ?>
        ...
        <a class="fre-btn fre-submit-btn" href="<?php echo bloginfo('url');?>/register/?role=professional"><?php _e('Sign up as a Pro', ET_DOMAIN)?></a>
	<?php }else{ ?>
		    ...
		    <a class="fre-btn fre-submit-btn" href="<?php echo get_post_type_archive_link( PROJECT ); ?>"><?php _e('Find Projects', ET_DOMAIN)?></a>
	<?php } ?>
</div>