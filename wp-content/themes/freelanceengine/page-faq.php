...
?>
    <div class="fre-page-wrapper">
        ...
        <div class="help-bg" style="background-image: url(<?php if (get_field("banner_picture") ) { the_field("banner_picture"); }?>);">
            <div class="container">
                                ...
                                <div class="help-post__item">
                                    <div class="help-post__image">
                                        <?php if (has_post_thumbnail()){?>
                                            <img src="<?php the_post_thumbnail_url();?>" alt="post-<?php echo $k?>">
                                        <?php } else { ?>
                                            <img src="<?php echo get_template_directory_uri(). '/img/noimg.png' ?>" alt="no_img">
                                        <?php }?>
                                    </div>
                                    <a class="help-post__title" href="<?php the_permalink(); ?>"><?php the_title(); ?></a>
                                    <?php if ( has_excerpt() ){ ?>
                        ...
                        <div class="help-tabs">
                            <ul class="help-tab__headers" id="Tabs" role="tablist">
                                ...
                                foreach ($rows as $row) { ?>
                                    ...
                                    <?php } $i++ ?>
                                            <a class="nav-link help-tab__header_link" data-toggle="tab" href="#tab-<?php echo $row['tab_id']?>" role="tab">
                            ...
                            foreach ($rows as $row) { ?>
                                ...
                                <?php } $j++ ?>
                                    <?php
                                        ...
                                        $terms = get_terms(array('taxonomy'=>$taxonomy, 'hide_empty'  => 0, 'parent' => $terms_id));
                                        $colc =  count($terms);
                                    ...
                                    <div class="help-tab__content_list">
                                        ...
                                        <div class="help-tab__item">
                                            <img class="help-tab__icon" src="<?php the_field('catic',$taxonomy . '_' . $termid);?>">
                                            <div class="help-tab__catalog  <?php if ( $termschild && !is_wp_error( $termschild ) ) :?> faa-parent <?php endif;?> animated-hover">
                                                <a class="help-tab__catalog_title" href="<?php echo $term_link?>"><?php echo $term->name; ?></a>
                                                        ...
                                                        if($partnersList->have_posts()) {
                                                            while($partnersList->have_posts()) {
                                                                ...
                                                                <li class="help-tab__catalog_item">
                                                                    <a class="help-tab__catalog_list" href="<?php the_permalink(); ?>"><?php the_title();?></a>
                                                                </li>
