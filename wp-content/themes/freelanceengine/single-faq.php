                        ...
                        <div class="fre-profile-box">
                            <ul class="help-list">
                                <?php foreach ($terms2 as $termParent) {
                                    ...
                                    ?>
                                    <li class="help-item <?php echo $class ?>"><a href="<?php echo $termLink ?>" class="help-link"><?php echo $termParent->name?></a>
                                                ...
                                                if($partnersList->have_posts()) {
                                                    while($partnersList->have_posts()) {
                                                        ...
                                                        <li class="help-sub__item <?php if($currenturl == $link){ ?>active<?php } ?>">
                                                            <a href="<?php the_permalink() ?>" class="help-sub__link"><?php the_title();?></a>
                                                        </li>
