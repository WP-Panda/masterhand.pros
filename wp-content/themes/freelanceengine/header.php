        ...
        <div class="container">
               <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-3 fre-site-logo">
                    <a class="col-lg-12 col-md-3 col-sm-4 col-xs-7 logo-head" href="/"><?php fre_logo( 'site_logo' ) ?><span>Low-Cost Service Deals</span></a>
                    <div class="col-xs-5 col-sm-8 col-md-9 hidden-lg fre-hamburger dropdown">
                        <?php if ( is_user_logged_in() ) { ?>
                            <a onclick="document.location.href='<?php echo et_get_page_link( 'list-notification' );?>'" class="fre-notification notification-tablet">
