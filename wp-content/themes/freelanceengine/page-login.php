                    ...
                    <div class="fre-authen-login">
                        ...
                        <form role="form" id="signin_form" class="">
                            ...
                            <div class="fre-input-field">
                                ...
                                <input type="text" name="user_login" class="need_valid" placeholder="<?php _e( 'Username or Email', ET_DOMAIN ) ?>">
                            </div>
                            <div class="fre-input-field">
                                <label><?php _e( 'Password', ET_DOMAIN ) ?></label>
                                <input type="password" name="user_pass" class="need_valid" placeholder="<?php _e( 'Password', ET_DOMAIN ) ?>">
                            </div>
