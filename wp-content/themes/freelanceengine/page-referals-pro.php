<?php
/**
 * Template Name: Why Referals are very important PRO
...
<div class="fre-page-wrapper page-benefits page-referals-benefits">
    <div class="container">
        <div id="if-pro">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-xs-12">
                            <div class="masterhan-create-wrap">
                                ...
                                <a href="<?php echo bloginfo('url');?>/register/?role=professional" class="fre-submit-btn masterhan-create__link"><?php echo _('GET MORE REFERRALS')?></a>
                            </div>
                ...
                <div class="masterhand-sign-up">
                    <div class="sign-up-wrap">
                        ...
                        <div class="sign-up__link">
                            <a class="fre-submit-btn" href="<?php echo bloginfo('url');?>/register/?role=professional"><?php echo _('GET MORE REFERRALS');?></a>
                        </div>
