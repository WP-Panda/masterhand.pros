                        ...
                        <div class="col-sm-6 col-xs-12">
                            <div class="masterhan-create-wrap">
                                ...
                                <a href="<?php echo bloginfo( 'url' ); ?>/register/?role=professional"
                                   class="fre-submit-btn masterhan-create__link"><?php echo _( 'GET MORE REFERRALS' ) ?></a>
                            </div>
                    ...
                    <div class="sign-up-wrap">
                        ...
                        <div class="sign-up__link">
                            <a class="fre-submit-btn"
                               href="<?php echo bloginfo( 'url' ); ?>/register/?role=professional"><?php echo _( 'GET MORE REFERRALS' ); ?></a>
                        </div>
