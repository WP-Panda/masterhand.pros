...
if (empty($_POST["txn_id"]) && $_POST['txn_type'] != 'web_accept') {
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="content-cancel-payment">
                        ...
                        <div class="content-footer">
                            <a class="fre-btn btn-center fre-submit-btn" href="<?php echo get_page_url('page-profile');?>"><?php _e('Return to Profile', ET_DOMAIN);?></a>
                        </div>
                    </div>
                </div>
            </div>
