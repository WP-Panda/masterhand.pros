...
?>
<div class="modal fade designed-modal <?php if(!have_posts()){ echo 'modal-invite-no-project'; }?>" id="modal_invite">
			...
			<div class="modal-header">
				...
				<form role="form" class="fre-modal-form text-center" id="submit_invite">
					...
					<div class="fre-form-btn">
						<button type="submit" class="fre-submit-btn btn-left btn-submit" <?php if($wp_query->found_posts == 0){echo 'disabled="disabled"';} ?> >
