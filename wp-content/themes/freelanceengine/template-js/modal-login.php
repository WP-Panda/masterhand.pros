            ...
            <div class="modal-body">
                <form role="form" id="signin_form" class="fre-authen-login auth-form signin_form">
                    <div class="fre-input-field">
                        ...
                        <input type="text" class="need_valid" id="login_user_login" name="user_login"
                               placeholder="<?php _e( 'Enter Username or Email', ET_DOMAIN ) ?>">
                    </div>
                    <div class="fre-input-field">
                        <label for="login_user_pass"><?php _e( 'Your Password', ET_DOMAIN ) ?></label>
                        <input type="password" class="need_valid" id="login_user_pass" name="user_pass"
                               placeholder="<?php _e( 'Enter Password', ET_DOMAIN ) ?>">
                    </div>
                    <div class="fre-form-btn">
                        <button type="submit" class="fre-submit-btn btn-left btn-submit btn-sumary btn-sub-create">
							<?php _e( 'Sign in', ET_DOMAIN ) ?>
                        </button>
                        <a class="fre-cancel-btn show-forgot-form"
                           href="#"><?php _e( "Forgot Password?", ET_DOMAIN ) ?></a>
						<?php
