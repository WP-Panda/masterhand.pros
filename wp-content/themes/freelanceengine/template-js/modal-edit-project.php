                    ...
                    <form class="post edit-project" role="form" id="frm_edit_project">
                        ...
                        <div class="form-group">
                            <label for="post_title"
                                   class="control-label title-plan"><?php _e( "Project Title", ET_DOMAIN ); ?></label>
                            <input type="text" class="input-item form-control text-field" id="post_title"
                                   placeholder="<?php _e( "Project Title", ET_DOMAIN ); ?>" name="post_title">
                        </div>
                        <!--// project title -->
                        ...
                        <div class="form-group">
                            <label for="et_budget"
                                   class="control-label title-plan"><?php printf( __( "Budget (%s)", ET_DOMAIN ), fre_currency_sign( false ) ); ?></label>
                            <input required type="number" min="1" class="input-item form-control text-field numberVal"
                                   id="et_budget" placeholder="<?php _e( "Budget", ET_DOMAIN ); ?>" name="et_budget">
                        </div>
                        <!--// project budget -->
                        <div class="clearfix"></div>
                        <!-- project skills -->
                        ...
                        <div class="form-group project_category">
							...
							<?php ae_tax_dropdown( 'project_category',
								array(
									'attr'            => 'data-chosen-width="500px" data-chosen-disable-search="" multiple data-placeholder="' . __( "Choose categories", ET_DOMAIN ) . '"',
                                    ...
                                    <li>
                                        <div class="plupload_buttons" id="carousel_container">
                                            <span class="img-gallery" id="carousel_browse_button">
                                                <a href="#" class="add-img"><?php _e( "Attach file", ET_DOMAIN ); ?> <i
                        ...
                        <div class="form-group">
                            ...
                            <label for="post_content"
                                   class="control-label title-plan"><?php _e( "Description", ET_DOMAIN ); ?></label>
						...
						<?php $post = '';
						do_action( 'ae_edit_post_form', PROJECT, $post ); ?>
                        <div class="form-group">
                            <button type="submit"
                                    class="fre-submit-btn btn-submit-login-form"><?php _e( "Submit", ET_DOMAIN ); ?></button>
                        </div>
                    </form>
                </div>
            </div>
