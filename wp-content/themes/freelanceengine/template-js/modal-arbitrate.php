        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" id="arbitrate_form" class="fre-modal-form fre-arbitrate-form">
                    ...
                    <p>
                        <strong><?php _e( 'Winning Bid:', ET_DOMAIN ); ?></strong> <span
                                id="modal_arbitrate_winning_bid"></span>$
                    </p>
                    ...
                    <div class="fre-input-field">
                        ...
                        <label class="radio-inline" for="arbitrate-comment-freelancer">
                            <input id="arbitrate-comment-freelancer" type="radio" name="split_comment"
                                   value="freelancer">
                            <span></span>
                        ...
                        <label class="radio-inline" for="arbitrate-comment-nobody">
                            <input id="arbitrate-comment-nobody" type="radio" name="split_comment" value="nobody"
                                   checked>
                            <span></span>
                    ...
                    <div class="fre-input-field">
                        <label class="fre-field-title"
                               for="split_value_freelancer"><?php _e( 'Professional', ET_DOMAIN ); ?></label>
                        <input id="split_value_freelancer" type="number" min="0" name="split_value_freelancer"
                               data-user-type="freelancer" placeholder="">
                        <span class="split_type_sign">%</span>
                    </div>

                    <div class="fre-input-field">
                        <label class="fre-field-title"
                               for="split_value_client"><?php _e( 'Employer', ET_DOMAIN ); ?></label>
                        <input id="split_value_client" type="number" min="0" name="split_value_client"
                               data-user-type="client" placeholder="">
                        <span class="split_type_sign">%</span>
                    </div>
