                ...
                <form class="form-save-avatar" data-processing='no'>
                    <div class="text-center">
                        ...
                        <div id="md_user_avatar_container" data-avatar_id="<?php echo $avatar_id ?>">
                            <button type="submit"
                                    class="fre-submit-btn btn-left fre-submit-portfolio"><?php _e( 'Save profile picture', ET_DOMAIN ) ?></button>

                            <a class="fre-form-close fre-cancel-btn btn-right" href="#"
                               id="md_user_avatar_browse_button" style="margin-left: 0">
								<?php _e( 'Change picture', ET_DOMAIN ) ?>
                            </a>
                            <span class="et_ajaxnonce hidden"
                                  id="<?php echo de_create_nonce( 'md_user_avatar_et_uploader' ); ?>"></span>
                        </div>
