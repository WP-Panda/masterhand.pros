<div class="modal fade designed-modal" id="acceptance_project" tabindex="-1" role="dialog"
	...
	if ( ae_get_option( 'user_credit_system' ) && class_exists( 'FRE_Credit' ) ):
		if ( is_use_credit_escrow() ):
            ...
            <div class="info-credit-balance">
                <p><?php _e( "Your credit balance: ", ET_DOMAIN ); ?><strong class="credit-balance">{{=
                        available_balance}}</strong></p>
