                ...
                <form role="form" class="fre-modal-form auth-form update_portfolio">
                    ...
                    <div class="fre-input-field box_upload_img">
                        ...
                        <div id="edit_portfolio_img_container" style="height: 50px">
                            <span class="et_ajaxnonce hidden"
                                  data-id="<?php echo de_create_nonce( 'edit_portfolio_img_et_uploader' ); ?>"></span>
                            ...
                            <a class="fre-upload-file" href="#" id="edit_portfolio_img_browse_button"
                               style="display: block;">
								<?php _e( 'Upload Files', ET_DOMAIN ) ?>
                            </a>
                    ...
                    <div class="fre-input-field no-margin-bottom">
                        ...
                        <label class="fre-checkbox checkline" for="best_work_edit">
                            <input class="input_best_work" id="best_work_edit" name="best_work_edit" type="checkbox"
                                   value="1" onclick="selectOnlyThis(1)">
                            <span><?php _e( 'Best work', ET_DOMAIN ); ?></span>
                        </label>
                    </div>
                    <div class="fre-input-field no-margin-bottom">
                        <label class="fre-checkbox checkline" for="client_edit">
                            <input class="input_client" id="client_edit" name="client_edit" type="checkbox" value="1"
