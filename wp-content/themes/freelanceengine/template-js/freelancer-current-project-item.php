<script type="text/template" id="freelancer_current_project_template_js">
    ...
    <div class="fre-table-col project-average-col"><span><?php _e( 'Average Bid', ET_DOMAIN ); ?></span>{{=
        bid_average}}
    </div>
    <div class="fre-table-col project-status-col <# if ( post_status === 'archive' ) { #>project-status-archive<# } #>">
        {{= project_status_view }}
    </div>
