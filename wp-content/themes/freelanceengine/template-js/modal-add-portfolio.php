            ...
            <div class="modal-body">
                <form role="form" id="create_portfolio" class="fre-modal-form auth-form create_portfolio">
                    ...
                    <div class="fre-input-field box_upload_img">
                        ...
                        <div id="portfolio_img_container" style="height: 50px">
                            <span class="et_ajaxnonce hidden"
                                  data-id="<?php echo wp_create_nonce( 'portfolio_img_et_uploader' ); ?>"></span>
                            ...
                            <a class="fre-upload-file" href="#" id="portfolio_img_browse_button"
                               style="display: block;">
								<?php _e( 'Upload Files', ET_DOMAIN ) ?>
                            </a>
                        </div>
                    ...
                    <div class="fre-input-field">
                        ...
                        <select class="fre-chosen-multi" name="profile_category" multiple
                                data-placeholder="<?php _e( 'Select an option', ET_DOMAIN ); ?>">
							<?php
							if ( $profile_id ) {
                    ...
                    <div class="fre-input-field no-margin-bottom">
                        <label class="checkline" for="best_work">
                            <input id="best_work" name="best_work" type="checkbox" value="1"
