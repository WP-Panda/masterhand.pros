        ...
        <div class="modal-content text-center">
            ...
            <div class="modal-body">
                <form role="form" id="review_form" class="review-form fre-modal-form">
                    ...
                    <input type="hidden" name="project_id" value="<?=is_page_template('page-profile.php') ? '' : $post->ID?>">
                    <input type="hidden" name="action" value="rwRating"/>
                    <input type="hidden" name="from_is" value="<?php echo (ae_user_role($user_ID) == FREELANCER) ? 'freelancer' : 'employer' ?>"/>
                    ...
                    <div class="fre-input-field">
                        ...
                        <textarea id="comment-content" name="comment" placeholder="<?php _e( 'Leave a reply...', ET_DOMAIN ); ?>"></textarea>
                    </div>
