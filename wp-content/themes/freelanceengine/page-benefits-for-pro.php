<?php
/**
 * Template Name: PRO benefits For Pro
...
<div class="fre-page-wrapper page-benefits page-benefits-for-pro">
    <div class="container">
        <div id="if-pro">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-xs-12">
                            <div class="masterhan-create-wrap">
                                ...
                                <a href="<?php echo bloginfo('url');?>/register/?role=professional" class="fre-submit-btn masterhan-create__link"><?php echo _('ACTIVATE A PRO PLAN')?></a>
                            </div>
                ...
                <div class="masterhand-sign-up">
                    <div class="sign-up-wrap">
                        ...
                        <div class="sign-up__link">
                            <a class="fre-submit-btn" href="<?php echo bloginfo('url');?>/register/?role=professional"><?php echo _('Activate a PRO plan');?></a>
                        </div>
