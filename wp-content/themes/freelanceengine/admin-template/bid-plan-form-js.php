        ...
        <div class="form payment-plan">
            ...
            <div class="form-item f-left-all clearfix">
                <div class="width33p">
                    ...
                    <input value="{{= et_price }}"
                           class="bg-grey-input width50p not-empty is-number required number gt_zero" name="et_price"
                           type="text"/>
                ...
                <div class="width33p">
                    ...
                    <input value="{{= et_number_posts }}"
                           class=" bg-grey-input width50p not-empty is-number required number gt_zero numberIsInteger"
