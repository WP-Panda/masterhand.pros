    ...
    <div class="form payment-plan">
        ...
        <div class="form-item f-left-all clearfix">
            <div class="width33p">
                ...
                <input class="bg-grey-input width50p not-empty is-number required number gt_zero" name="et_price"
                       type="text"/>
				<?php ae_currency_sign(); ?>
            </div>
            <div class="width33p">
                <div class="label"><?php _e( "Acquired bids for this package", ET_DOMAIN ); ?></div>
                <input class="bg-grey-input width50p not-empty is-number required number gt_zero numberIsInteger"
