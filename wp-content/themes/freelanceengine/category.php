...
<div class="container">
    ...
    <div class="fre-blog">
        ...
        <div class="fre-blog-list-sticky">
            <div class="row">
                ...
                <?php $query = new WP_Query(array('posts_per_page' => 1,'ignore_sticky_posts' => 1, 'post_type' => 'post', 'post_status' => 'publish', 'post__in' => $sticky, 'orderby'=> 'date', 'order'=>'desc')); ?>
                ...
                <div class="col-sm-5 col-md-4 col-lg-4 col-xs-12">
                    <?php $query = new WP_Query(array('posts_per_page' => 3,'offset'=>1,'ignore_sticky_posts' => 1, 'post_type' => 'post', 'post_status' => 'publish', 'post__in' => $sticky, 'orderby'=> 'date', 'order'=>'desc')); ?>
                    <?php  while($query->have_posts()) { $query->the_post();
        ...
        <div class="fre-blog-fst_bl">
            <?php $query1 = new WP_Query(array('post_type' => 'post', 'post_status' => 'publish', 'posts_per_page' => 10, 'category__in' => $blog_category1)); ?>
        ...
        <div class="fre-blog-snd_bl">
            <?php $query2 = new WP_Query(array('post_type' => 'post', 'post_status' => 'publish', 'posts_per_page' => 10, 'cat' => $blog_category2));
            ...
            <div class="fre-blog-list owl-carousel hidden-xs">
                <div class="fre-blog-list-item row">
                    <?php $i = 0; while($query2->have_posts()) { $query2->the_post();
        ...
        <div class="fre-blog-snd_bl">
            <?php $query3 = new WP_Query(array('post_type' => 'post', 'post_status' => 'publish', 'posts_per_page' => 10, 'cat' => $blog_category3));?>
            ...
            <div class="fre-blog-list owl-carousel hidden-xs">
                <div class="fre-blog-list-item row">
                    <?php $i = 0; while($query3->have_posts()) { $query3->the_post();
                            get_template_part('template/blog', 'item2');
                            $i++; if ($i == 6) {?>
                </div>
                <div class="fre-blog-list-item row">
        ...
        <div class="fre-blog-thd_bl">
            <?php $query4 = new WP_Query(array('post_type' => 'post', 'post_status' => 'publish', 'posts_per_page' => 10, 'cat' => $blog_category4)); ?>
            ...
            <div class="fre-blog-list owl-carousel hidden-xs">
                <div class="fre-blog-list-item row">
                    <?php $i = 0; while($query4->have_posts()) { $query4->the_post();
        ...
        <div class="sub-category">
            ...
            $terms = get_terms(array('taxonomy'=>$taxonomy, 'hide_empty'  => 0, 'parent' => 1));
                ...
                <div class="row">
                    <div class="col-sm-3 col-xs-12">
                        <div class="profs-cat-list_t text-center">
                            <a href="<?php echo get_term_link(1, $taxonomy); ?>">
                                <i class="blog-icon" style="background: rgba(255,255,255,0.1) url(<?php the_field('catic',$taxonomy . '_1');?>) center no-repeat;"></i>
                    ...
                    <div class="col-sm-3 col-xs-6">
                        ...
                        <div class="profs-cat-list_t text-center">
                            <a href="<?php echo get_term_link($term->slug, $taxonomy); ?>" class="active">
                                <?php echo $term->name; ?></a>
                        </div>
                        <? else: ?>
                            <div class="profs-cat-list_t text-center">
            ...
            <div class="fre-blog-list-sticky">
                <div class="row">
                    <?php $sticky = get_option( 'sticky_posts' );
            $query = new WP_Query(array('cat'=>$term_id,'posts_per_page' => 2,'ignore_sticky_posts' => 1, 'post_status' => 'publish', 'post__in' => $sticky, 'orderby'=> 'date', 'order'=>'desc'));
    ...
    wp_reset_query();?>
                ...
                <div class="row">
                    <?php $query = new WP_Query(array('cat'=>$term_id,'posts_per_page' => 3,'offset'=>2,'ignore_sticky_posts' => 1, 'post_status' => 'publish', 'post__in' => $sticky, 'orderby'=> 'date', 'order'=>'desc'));
            while($query->have_posts()) { $query->the_post();
                  $notin[] = get_the_ID();?>
            ...
            */?>
            ...
            <div class="fre-blog-snd_bl">
                <?php $query = new WP_Query(array('post_type' => 'post', 'post_status' => 'publish', 'posts_per_page' => 4, 'cat' => $term_id,'ignore_sticky_posts' => 1, 'orderby'=> 'date', 'order'=>'desc', 'post__not_in'=>$notin));
                ?>
                <div class="fre-blog-list">
                    <div class="fre-blog-list-item row">
                        ...
                        <a id="true_loadmore" class="fre-submit-btn blog_loadmore"><?php echo __('Show more',ET_DOMAIN);?></a>
                        <?php endif;?>
                    </div>
                </div>
                <?php wp_reset_query();?>
