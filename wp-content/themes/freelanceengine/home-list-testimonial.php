                ...
                <div class="stories-content">
                   <div class="row">
                        <div class="col-sm-2 col-xs-12">
                             <div class="stories-img" style="background:url(<?php if(has_post_thumbnail($post)){  the_post_thumbnail_url( 'thumbnail' );} else { echo get_template_directory_uri().'/img/noimg.png';}?>) center no-repeat;"></div>
                        </div>         
