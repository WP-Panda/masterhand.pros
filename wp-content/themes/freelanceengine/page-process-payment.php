                            ...
                            <div class="step-payment-complete">
                                ...
                                <div class="fre-view-project-btn">
                                    <a class="fre-submit-btn"
                                       ...
                                       href="<?php $project_url = get_the_permalink($session['ad_id']); echo $project_url;?>"><?php _e("Return to Project", ET_DOMAIN); ?></a>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    switch ($type) {
                                        case 'pro_plan':
                                            ...
                                            */
                                            ...
                                            // check time
                                            $option_property = $wpdb->get_row(
                                                'SELECT * FROM ' . $wpdb->prefix . 'pro_options
                                            ...
                                            */
                                            ...
                                            $duplicate_user = $wpdb->get_row(
                                                'SELECT id FROM ' . $wpdb->prefix . 'pro_paid_users WHERE user_id = ' . $user_id
                                            );
