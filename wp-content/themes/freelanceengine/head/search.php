        ...
        <div class="row">
            <div class="col-md-12">
                <div class="select-search-top">
                    <select data-placeholder="<?php _e( "Searching", ET_DOMAIN ) ?>" class="search-filter chosen-select"
                            data-chosen-width="300px" data-chosen-disable-search="true">
            ...
            <div class="col-md-12 projects-search-container">
                <p class="wrapper-input-search-top">
                    <input type="text" name="s" class="search field-search-top" autocomplete="off"
                           placeholder="<?php _e( "TYPE KEYWORD HERE", ET_DOMAIN ) ?>">
