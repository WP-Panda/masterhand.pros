...
<div class="fre-profile-box skills_awards_wp">
    <div class="row skills_awards">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 skill-list">
            ...
            <div class="bl_t">
				<?php _e( 'Skills and Endorsements:', WPP_TEXT_DOMAIN );
				if ( ! $is_company ) { ?>
                    <div class="skill-list__placeholder">
                        <?php _e( 'You can put here your personal skills, related keywords . For example Polite, Demanding, Recognize Brilliance, Pay Promptly etc.', WPP_TEXT_DOMAIN ); ?>
                    </div>
				<?php } else { ?>
                    <div class="skill-list__placeholder">
						<?php _e( 'You can put here your professional and personal skills, related keywords . For example Drilling, General Woodworking, Cleaning Sewer Lines, Problem-Solving etc.', WPP_TEXT_DOMAIN );
						?>
                    </div>
				<?php } ?>
            </div>
