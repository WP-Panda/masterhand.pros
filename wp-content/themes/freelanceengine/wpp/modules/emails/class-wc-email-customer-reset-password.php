...
if ( ! class_exists( 'WC_Email_Customer_Reset_Password', false ) ) :
	...
	class WC_Email_Customer_Reset_Password extends WC_Email {
		...
		public function __construct() {
			...
			$this->title       = __( 'Reset password', 'wpp' );
			$this->description = __( 'Customer "reset password" emails are sent when customers reset their passwords.', 'wpp' );

			$this->template_html  = 'emails/customer-reset-password.php';
			$this->template_plain = 'emails/plain/customer-reset-password.php';

			// Trigger.
			add_action( 'wpp_reset_password_notification', array( $this, 'trigger' ), 10, 2 );
		...
		public function get_default_subject() {
			return __( 'Password Reset Request for {site_title}', 'wpp' );
		}
		...
		public function get_default_heading() {
			return __( 'Password Reset Request', 'wpp' );
		}
		...
		public function get_default_additional_content() {
			return __( 'Thanks for reading.', 'wpp' );
		}
	}
