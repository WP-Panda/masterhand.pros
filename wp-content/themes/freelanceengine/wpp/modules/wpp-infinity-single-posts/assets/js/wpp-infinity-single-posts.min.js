...
jQuery(function(t){var a=!1,o=WppAjax.container,n=WppAjax.ajax_url,e={allow:!0,reallow:function(){scroll.allow=!0},delay:WppAjax.delay,offset:WppAjax.offset};function l(){t(".wpp-permalink").each(function(){var a=t(this),o=a.position();a.scrollspy({min:o.top,max:o.top+a.height(),onEnter:function(t){window.history.pushState([],"",a.attr("data-link")),window.document.title=a.text()}})})}t(window).scroll(function(){var i=t('[name="wpp-posts-need"]').attr("content");if((e.allow=!!i,!a&&e.allow)&&t(document).height()-t("footer").height()-t(window).scrollTop()<e.offset){a=!0;var p={action:"wpp_infinity_loading",posts:i};t.post(n,p,function(n){if(n.success){if(t('[name="wpp-posts-need"]').attr("content",n.data.posts),t(o).append(n.data.post),l(),window.history.pushState([],"",n.data.permalink),t(".animated-thumbnails-gallery").length)for(var i=document.querySelectorAll(".animated-thumbnails-gallery"),p=0;p<i.length;p++)lightGallery(i[p],{animateThumb:!1,zoomFromOrigin:!1,allowMediaOverlap:!0,toggleThumb:!0});a=!1,e.allow=!0}})}}),l()});