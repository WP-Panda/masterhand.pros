...
HTML;
            ...
            <p class="add_wpp_post_images hide-if-no-js">
                <a href="javascript:void(0);"
                   data-choose="<?php esc_attr_e( 'Добавить картинку в Галлерею', 'wpp-fr' ); ?>"
		...
		public static function save( $post_id, $post ) {
			$gallery_attachment_ids = isset( $_POST[ 'wpp_post_gallery' ] ) ? array_filter( explode( ',', wc_clean( $_POST[ 'wpp_post_gallery' ] ) ) ) : [];
