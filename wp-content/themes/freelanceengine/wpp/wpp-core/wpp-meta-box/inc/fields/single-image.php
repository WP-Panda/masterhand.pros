 ...
 */
class WPP_MB_Single_Image_Field extends WPP_MB_Image_Advanced_Field {
	/**
	...
	public static function get_value( $field, $args = array(), $post_id = null ) {
		$value = WPP_MB_Field::get_value( $field, $args, $post_id );

		if ( ! is_array( $value ) ) {
			return WPP_MB_Image_Field::file_info( $value, $args, $field );
		}

		$return = array();
		foreach ( $value as $image_id ) {
			$return[] = WPP_MB_Image_Field::file_info( $image_id, $args, $field );
		}
