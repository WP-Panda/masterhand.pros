 ...
 */
class WPP_MB_File_Field extends WPP_MB_Field {
	/**
	 * Enqueue scripts and styles.
	 */
	public static function admin_enqueue_scripts() {
		wp_enqueue_style( 'rwmb-file', WPP_MB_CSS_URL . 'file.css', array(), WPP_MB_VER );
		wp_enqueue_script( 'rwmb-file', WPP_MB_JS_URL . 'file.js', array( 'jquery-ui-sortable' ), WPP_MB_VER, true );
	...
	public static function add_actions() {
		...
		add_action( 'wp_ajax_wpp_mb_delete_file', array( __CLASS__, 'ajax_delete_file' ) );
	}
	...
	public static function ajax_delete_file() {
		...
		$field       = wpp_mb_get_field_settings( $field_id, array( 'object_type' => $object_type ), $object_id );
	...
	public static function html( $meta, $field ) {
		...
		$i18n_more = apply_filters( 'wpp_mb_file_add_string', _x( '+ Add new file', 'file upload', 'meta-box' ), $field );
	...
	protected static function file_html( $file, $index, $field ) {
		$i18n_delete = apply_filters( 'wpp_mb_file_delete_string', _x( 'Delete', 'file upload', 'meta-box' ) );
		$i18n_edit   = apply_filters( 'wpp_mb_file_edit_string', _x( 'Edit', 'file upload', 'meta-box' ) );
