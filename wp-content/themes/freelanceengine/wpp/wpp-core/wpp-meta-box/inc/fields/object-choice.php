 ...
 */
abstract class WPP_MB_Object_Choice_Field extends WPP_MB_Choice_Field {
	/**
	 * Show field HTML.
	...
	public static function admin_enqueue_scripts() {
		WPP_MB_Input_List_Field::admin_enqueue_scripts();
		WPP_MB_Select_Field::admin_enqueue_scripts();
		WPP_MB_Select_Tree_Field::admin_enqueue_scripts();
		WPP_MB_Select_Advanced_Field::admin_enqueue_scripts();
	}
	...
	protected static function get_type_class( $field ) {
		if ( in_array( $field['field_type'], array( 'checkbox_list', 'radio_list' ), true ) ) {
			return 'WPP_MB_Input_List_Field';
		}
		return WPP_MB_Helpers_Field::get_class(
			array(
