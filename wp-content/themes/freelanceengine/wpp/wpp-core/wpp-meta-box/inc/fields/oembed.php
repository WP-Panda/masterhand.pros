 ...
 * OEmbed field class.
 */
class WPP_MB_OEmbed_Field extends WPP_MB_Text_Field {
	/**
	...
	public static function admin_enqueue_scripts() {
		wp_enqueue_style( 'rwmb-oembed', WPP_MB_CSS_URL . 'oembed.css', '', WPP_MB_VER );
		wp_enqueue_script( 'rwmb-oembed', WPP_MB_JS_URL . 'oembed.js', array( 'jquery', 'underscore' ), WPP_MB_VER, true );
	}
	...
	public static function add_actions() {
		add_action( 'wp_ajax_wpp_mb_get_embed', array( __CLASS__, 'wp_ajax_get_embed' ) );
	}
	...
	public static function get_embed( $url, $not_available = '' ) {
		...
		$not_available = apply_filters( 'wpp_mb_oembed_not_available_string', $not_available );
