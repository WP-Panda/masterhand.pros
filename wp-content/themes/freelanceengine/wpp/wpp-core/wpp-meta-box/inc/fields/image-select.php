 ...
 */
class WPP_MB_Image_Select_Field extends WPP_MB_Field {
	/**
	 * Enqueue scripts and styles.
	 */
	public static function admin_enqueue_scripts() {
		wp_enqueue_style( 'rwmb-image-select', WPP_MB_CSS_URL . 'image-select.css', array(), WPP_MB_VER );
		wp_enqueue_script( 'rwmb-image-select', WPP_MB_JS_URL . 'image-select.js', array( 'jquery' ), WPP_MB_VER, true );
	}
