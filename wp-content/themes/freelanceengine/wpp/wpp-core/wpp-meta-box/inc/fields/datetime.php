 ...
 */
class WPP_MB_Datetime_Field extends WPP_MB_Text_Field {
	/**
	...
	public static function admin_register_scripts() {
		...
		wp_register_style( 'rwmb-date', WPP_MB_CSS_URL . 'datepicker.css', array( 'jquery-ui-datepicker' ), '1.8.17' );
		...
		wp_register_script( 'rwmb-datetime', WPP_MB_JS_URL . 'datetime.js', array( 'jquery-ui-datepicker', 'jquery-ui-timepicker-i18n' ), WPP_MB_VER, true );
		wp_register_script( 'rwmb-date', WPP_MB_JS_URL . 'date.js', array( 'jquery-ui-datepicker' ), WPP_MB_VER, true );
		wp_register_script( 'rwmb-time', WPP_MB_JS_URL . 'time.js', array( 'jquery-ui-timepicker-i18n' ), WPP_MB_VER, true );
		...
		foreach ( $handles as $handle ) {
			WPP_MB_Helpers_Field::localize_script_once( "rwmb-$handle", 'WPP_MB_' . ucfirst( $handle ), $data );
		}
	}
