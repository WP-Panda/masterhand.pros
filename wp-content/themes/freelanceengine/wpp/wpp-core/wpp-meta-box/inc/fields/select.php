 ...
 * Select field class.
 */
class WPP_MB_Select_Field extends WPP_MB_Choice_Field {
	/**
	 * Enqueue scripts and styles.
	 */
	public static function admin_enqueue_scripts() {
		wp_enqueue_style( 'rwmb-select', WPP_MB_CSS_URL . 'select.css', array(), WPP_MB_VER );
		wp_enqueue_script( 'rwmb-select', WPP_MB_JS_URL . 'select.js', array( 'jquery' ), WPP_MB_VER, true );
	}
	...
	public static function html( $meta, $field ) {
		...
		$walker                      = new WPP_MB_Walker_Select( $field, $meta );
		$output                      = sprintf(
			'<select %s>',
