 ...
 */
class WPP_MB_Wysiwyg_Field extends WPP_MB_Field {
	/**
	...
	public static function admin_enqueue_scripts() {
		wp_enqueue_style( 'rwmb-wysiwyg', WPP_MB_CSS_URL . 'wysiwyg.css', array(), WPP_MB_VER );
		wp_enqueue_script( 'rwmb-wysiwyg', WPP_MB_JS_URL . 'wysiwyg.js', array( 'jquery' ), WPP_MB_VER, true );
	}
	...
	public static function normalize( $field ) {
		...
		$field['options'] = apply_filters( 'wpp_mb_wysiwyg_settings', $field['options'] );
