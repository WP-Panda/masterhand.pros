 ...
 * Map field class.
 */
class WPP_MB_Map_Field extends WPP_MB_Field {
	/**
	 * Enqueue scripts and styles.
	 */
	public static function admin_enqueue_scripts() {
		wp_enqueue_style( 'rwmb-map', WPP_MB_CSS_URL . 'map.css', array(), WPP_MB_VER );
		 ...
		 */
		$google_maps_url = apply_filters( 'wpp_mb_google_maps_url', $google_maps_url );
		wp_register_script( 'google-maps', esc_url_raw( $google_maps_url ), array(), WPP_MB_VER, true );
		wp_enqueue_script(
			'rwmb-map',
			WPP_MB_JS_URL . 'map.js',
			array(
	...
	public static function render_map( $location, $args = array() ) {
		...
		$google_maps_url = apply_filters( 'wpp_mb_google_maps_url', $google_maps_url );
		wp_register_script( 'google-maps', esc_url_raw( $google_maps_url ), array(), WPP_MB_VER, true );
		wp_enqueue_script( 'rwmb-map-frontend', WPP_MB_JS_URL . 'map-frontend.js', array( 'google-maps' ), WPP_MB_VER, true );
