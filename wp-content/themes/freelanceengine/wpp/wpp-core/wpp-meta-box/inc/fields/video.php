 ...
 */
class WPP_MB_Video_Field extends WPP_MB_Media_Field {
	/**
	 * Enqueue scripts and styles.
	 */
	public static function admin_enqueue_scripts() {
		parent::admin_enqueue_scripts();
		wp_enqueue_style( 'rwmb-video', WPP_MB_CSS_URL . 'video.css', array( 'rwmb-media' ), WPP_MB_VER );
		wp_enqueue_script( 'rwmb-video', WPP_MB_JS_URL . 'video.js', array( 'rwmb-media' ), WPP_MB_VER, true );
	...
	public static function print_templates() {
		...
		require_once WPP_MB_INC_DIR . 'templates/video.php';
	}
}
