 ...
 */
class WPP_MB_Meta_Box_Registry {
	/**
	 ...
	 *
	 * @param WPPMB_Meta_Box $meta_box Meta box instance.
	 */
	public function add( WPPMB_Meta_Box $meta_box ) {
	 ...
	 *
	 * @return WPPMB_Meta_Box|bool False or meta box object.
	 */
