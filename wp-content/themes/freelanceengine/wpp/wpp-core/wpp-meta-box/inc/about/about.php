...
class WPP_MB_About {
				...
				<div id="post-body" class="metabox-holder columns-2">
					<div id="post-body-content">
						<div class="about-wrap">
							...
							do_action( 'wpp_mb_about_tabs_content' );
							?>
						</div>
					</div>
	...
	public function enqueue() {
		wp_enqueue_style( 'meta-box-about', WPP_MB_URL . 'inc/about/css/about.css', array(), WPP_MB_VER );
		wp_enqueue_script( 'meta-box-about', WPP_MB_URL . 'inc/about/js/about.js', array( 'jquery' ), WPP_MB_VER, true );
	}
	...
	protected function has_menu() {
		return apply_filters( 'wpp_mb_admin_menu', false );
	}
