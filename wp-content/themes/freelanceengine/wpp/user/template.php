...
function fre_stripe_card_form() {
    ...
    <div class="fre-input-field">
        ...
        <input name="stripe_email" tabindex="19" id="stripe_email" type="text" size="20" data-stripe="email"
               class="bg-default-input not_empty" placeholder="youremail@gmail.com"/>
    </div>


    <div class="fre-input-field name_card">
        <label class="fre-field-title" for="name_card"><?php _e( 'Name on card', ET_DOMAIN ); ?></label>
        <input tabindex="23" name="name_card" id="name_card" data-stripe="name" class="bg-default-input not_empty"
               type="text"/>
    </div>
    ...
    <div class="row" style="margin-bottom: 30px">
        <div class="col-sm-7">
            <div class="fre-input-field fld-wrap">
                ...
                <input name="stripe_number" tabindex="20" id="stripe_number" type="text" size="20" data-stripe="number"
                       class="bg-default-input not_empty"
            ...
            <div class="fre-input-field">
                ...
                <div class="row">
                    <div class="col-xs-6" style="padding-right:5px;">
                        <input tabindex="21" type="text" size="2" data-stripe="exp-month" placeholder="MM"
                               class="bg-default-input not_empty" id="exp_month" name="exp_month"/>
                    </div>
                    <div class="col-xs-6" style="padding-left:5px;">
                        <input tabindex="22" type="text" size="4" data-stripe="exp-year" placeholder="YY"
                               class="bg-default-input not_empty" id="exp_year" name="exp_year"/>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="fre-input-field" style="margin-bottom: 0">
        ...
        <input tabindex="24" type="text" size="3" data-stripe="cvc" class="bg-default-input not_empty input-cvc "
               placeholder="CVC" id="cvc" name="cvc"/>
    </div>
<?php }
                ...
                <div class="modal-header">
                    ...
                    <div class="info slogan">
                        <h4 class="modal-title"><span
                                    class="plan_name"><?php _e( "Update Stripe Acount", ET_DOMAIN ); ?></span></h4>
                    </div>
                </div>
                <div class="modal-body">
                    <form class="modal-form fre-modal-form" id="stripe_form" novalidate="novalidate" autocomplete="on"
                          data-ajax="false">
						<?php fre_stripe_card_form(); ?>
                        <div class="fre-form-btn">
                            <button class="fre-normal-btn btn-submit" type="submit"
                                    id="submit_stripe"> <?php _e( 'Update', ET_DOMAIN ); ?> </button>
