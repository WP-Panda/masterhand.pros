                            ...
                            <div class="col-sm-12 col-md-8 col-lg-8 col-xs-12 fre-profile-rating fre-profile-box">
                                <div class="fre-profile-rating_t">
									<?php echo __( "My rating", ET_DOMAIN ); ?><span
                                            class="total-rating">+<?= getActivityRatingUser( $user_ID ) ?></span>
                                </div>
                                <ul class="pro-dop">
                                    <li>
										<?php echo __( "PRO status ", ET_DOMAIN ); ?><span
                                                class="pro-rating">+<?= getActivityProRatingUser( $user_ID ) ?></span>
                                    </li>
                                </ul>
                                <ul class="dop">
                                ...
                                <div class="category">
									<?php if ( fre_share_role() || ae_user_role( $user_data->ID ) == FREELANCER ) { ?>
                                        <div class="fre-blog-item fre-blog-item-2">
                                            <div class="overlay-block">
                                                ...
                                                <div class="fre-blog-item_d center"><p>Some 2-3 articles/posts per month
                                                        would work very effectively to promote your business and support
                                        ...
                                        <div class="fre-blog-item fre-blog-item-2">
                                            <div class="overlay-block">
                                                <div class="fre-blog-item_t center"><a href="/pro-benefits-for-pro/">Pro
                                                        benefits for Pro</a></div>
                                                <div class="fre-blog-item_d center"><p>You are a Trusted Professional.
                                        ...
                                        <div class="fre-blog-item fre-blog-item-2">
                                            <div class="overlay-block">
                                                <div class="fre-blog-item_t center"><a
                                                            href="/why-referals-are-very-important-pro-2/">Why referals
                                                        are very important for PRO</a></div>
                                                <div class="fre-blog-item_d center"><p>You can be in TOP Professionals.
                                                        Promote your business constantly. Share your profile via email,
									...
									<?php } else { ?>
                                        <div class="fre-blog-item fre-blog-item-1">
                                            <div class="overlay-block">
                                                <div class="fre-blog-item_t center"><a href="/pro-benefits-for-client/">Pro
                                                        benefits for Client</a></div>
                                                <div class="fre-blog-item_d center"><p>You are a Trusted Client. Choose
                                        ...
                                        <div class="fre-blog-item fre-blog-item-1">
                                            <div class="overlay-block">
                                                <div class="fre-blog-item_t center"><a
                                                            href="/why-referals-are-very-important-client/">Why referals
                                                ...
                                                <div class="fre-blog-item_d center"><p>You can be a highly ranked
                                                        ...
                                                        constantly. Invite new referrals using special tools via email
                    ...
                    <div class="tabs_wp fre-profile-box referalac col-sm-12 col-xs-12">
                        ...
                        <div class="col-sm-3 col-xs-12">
                            ...
                            <table class="table table-hover accordion">
                                <a href='<?= '/give-endorsements' . $sponsor_name ?>' class='unsubmit-btn btn-right'
