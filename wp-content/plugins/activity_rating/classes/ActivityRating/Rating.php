...
//
		add_action('activityRating_paymentEscrowProject', [self::getInstance(), 'employerPaymentProject'], 1, 1);
		...
		add_action('activityRating_projectSuccessFreelancer', [self::getInstance(), 'doActionProjectSuccessFreelancer'], 1, 2);
