...
define('ACTIVITY_RATING_RELATIVE', '/wp-content/plugins/' . basename(__DIR__) );
add_action('plugins_loaded', 'activity_rating_load', 0);
add_action('admin_menu', 'add_menu_activity_rating', 1);

function activity_rating_load()
{
	require_once ABSPATH . 'vendor/autoload.php';
	require_once __DIR__ . '/classes/AutoloadActivityRating.php';
...
{
	add_menu_page(
		__('Activity Rating', 'activity_rating'),
		__('Activity Rating', 'activity_rating'),
		'administrator',
		'activity_rating',
