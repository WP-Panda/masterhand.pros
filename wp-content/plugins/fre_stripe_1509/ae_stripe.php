...
/*
Plugin Name: FrE Stripe UPD
Plugin URI: http://enginethemes.com/
Description: Integrates the Stripe payment gateway to your FreelanceEngine site
Version: 1.4
Author: enginethemes
...
function ae_stripe_require_plugin_file(){
    require_once dirname(__FILE__) . '/update.php';
}
add_action('after_setup_theme', 'ae_stripe_require_plugin_file');
...
add_action('after_payment_list_upgrade_account', 'ae_stripe_render_button');
...
?>
  ...
  <li class="panel">
    <h3 data-type="stripe">Credit Card or Debit Visa/MC Card Payment</h3>
    <div class="payment__method">
      <ul class="card">
        <li><a href="#"><img src="<?php bloginfo('template_url'); ?>/img/visa.png" alt=""></a></li>
        <li><a href="#"><img src="<?php bloginfo('template_url'); ?>/img/mc.png" alt=""></a></li>
        <li><a href="#"><img src="<?php bloginfo('template_url'); ?>/img/american.png" alt=""></a></li>
        <li><a href="#"><img src="<?php bloginfo('template_url'); ?>/img/jcb.png" alt=""></a></li>
        <li><a href="#"><img src="<?php bloginfo('template_url'); ?>/img/discover.png" alt=""></a></li>
      </ul>
      <a data-toggle="collapse" data-type="stripe" data-parent="#fre-payment-accordion" href="#fre-payment-stripe" class="btn-left collapsed other-payment fre-submit-btn"><?php _e("PAY WITH A CARD", ET_DOMAIN); ?></a>
    </div>
...
add_action('ae_payment_script', 'ae_stripe_add_script');
function ae_stripe_add_script() {
    global $user_ID, $ae_post_factory;
    $ae_pack = $ae_post_factory->get('pack');
    $packs = $ae_pack->fetch();
...
function ae_stripe_setup_payment($response, $paymentType, $order) {
    ...
    if ($paymentType == 'STRIPE') {
        ...
        try {
            ...
            if( ! in_array( $order_pay['currencyCodeType'], get_zero_decimal_currencies() ) ) {
                $amount *= 100;
            }
            ...
            $response = array(
                'success' => true,
                'data' => array(
                    'url' => $returnURL //'https://www.masterhand.pro/payment-completed'
                ) ,
                'paymentType' => 'stripe'
            );
        }
 ...
 * @author Tudt
 */
function get_zero_decimal_currencies() {
