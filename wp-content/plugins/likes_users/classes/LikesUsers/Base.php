...
class Base
{
	...
	const tbLikePost = 'likes_posts';
	const tbLikeComment = 'likes_comments';

	public $tbLikePost = '';
	public $tbLikeComment = '';
	...
	public function __construct()
	{
		...
		$this->tbLikePost = $this->tb_prefix . self::tbLikePost;
		$this->tbLikeComment = $this->tb_prefix . self::tbLikeComment;
...
//			$response['debug'] = debug_backtrace();
	...
	{
		$tb_name = empty($tb_name)? $this->tbLikePost : $tb_name;
