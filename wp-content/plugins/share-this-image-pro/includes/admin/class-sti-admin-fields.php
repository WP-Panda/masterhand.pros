...
if ( ! class_exists( 'STI_PRO_Admin_Fields' ) ) :

    /**
     * Class for plugin admin ajax hooks
     */
    class STI_PRO_Admin_Fields {

        /**
         * @var STI_PRO_Admin_Fields The array of options that is need to be generated
         */
        private $options_array;

        /**
         * @var STI_PRO_Admin_Fields Current plugin instance options
         */
                ...
                switch ( $value['type'] ) {
                                ...
                                <ul data-add-number-list class="items-list clearfix">
                                    ...
                                    if ( ! empty( $page_ids_array ) ) {
                                        ...
                                        foreach( $page_ids_array as $page_id ) {
                                            echo '<li class="item">';
                                                echo '<span data-name="' . esc_attr( $page_id ) . '" class="name">' . $page_id . '</span>';
                    ...
                    case 'textarea': ?>
                        <tr valign="top">
                            <th scope="row"><?php echo esc_html( $value['name'] ); ?></th>
                            <td>
                                <textarea id="<?php echo esc_attr( $value['id'] ); ?>" name="<?php echo esc_attr( $value['id'] ); ?>" cols="45" rows="3"><?php print isset( $plugin_options[ $value['id'] ] ) ? stripslashes( $plugin_options[ $value['id'] ] ) : ''; ?></textarea>
                                <br><span class="description"><?php echo wp_kses_post( $value['desc'] ); ?></span>
                            </td>
                        </tr>
                        <?php break;
                                    ...
                                    <?php foreach ( $value['choices'] as $val => $img ) { ?>
                                        <li class="option">
                                            <div class="option-inner">
                                                ...
                                                <span class="ico">
                                                    <img src="<?php echo esc_url( STI_PRO_URL . '/assets/images/' . $img ); ?>" alt="">
                                                </span>
                                            </div>
                                        </li>
                                    <?php } ?>
