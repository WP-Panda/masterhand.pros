<?php
/*
Plugin Name: Share This Image PRO
...
define( 'STI_PRO_VER', '1.49' );

define( 'STI_PRO_DIR', dirname( __FILE__ ) );
define( 'STI_PRO_URL', plugins_url( '', __FILE__ ) );
define( 'STI_PRO_BASENAME', plugin_basename(__FILE__) );

define( 'STI_PRO_UPDATE_URL', 'https://api.wpitem.com/' );


if ( ! class_exists( 'STI_PRO_Main' ) ) :
 ...
 * @class STI_PRO_Main
 */
final class STI_PRO_Main {

    /**
     * @var STI_PRO_Main The single instance of the class
     */
    protected static $_instance = null;

    /**
     * @var STI_PRO_Main License instance
     */
    public $license = null;

    /**
     * Main STI_PRO_Main Instance
     *
     * Ensures only one instance of STI_PRO_Main is loaded or can be loaded.
     *
     * @static
     * @return STI_PRO_Main - Main instance
     */
    ...
    private function includes() {
        ...
        // License
        include_once( 'license/class-sti-license.php' );
    ...
    public function init() {
        $this->license = new STI_License( STI_PRO_VER, STI_PRO_UPDATE_URL, STI_PRO_BASENAME );
    }
...
/**
 * Returns the main instance of STI_PRO_Main
 *
 * @return STI_PRO_Main
 */
function STI_PRO() {
    return STI_PRO_Main::instance();
}
