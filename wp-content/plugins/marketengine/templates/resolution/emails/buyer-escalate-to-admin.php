<?php
/**
 * This is an email template send to admin when buyer escalate dispute
 *
...
<p>
<?php printf(__("Buyer %s has escalated the dispute for the transaction: <a href='%s' >#%d</a>. ", "enginethemes"), $sender_name, $order_link, $order_id); ?>
