<div class="workspace-payment-code-wrap">
    <? if($dataCode['used']){ ?>
        <div class="fre-submit-btn paycode open-modal-review" data-pid="<?=$projectId;?>"><? _e('Review for Professional');?></div>
        <style>
    ...
    <div class="workspace-payment-code">
        <div class="client-code">
            ...
            <button class="fre-submit-btn send-payment-code" data-pid="<?=$projectId?>"><?php _e( 'Get it by email', ET_DOMAIN ); ?></button>
        </div>
    </div>
    <? } ?>
</div>