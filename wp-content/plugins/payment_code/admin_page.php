...
?>
<div class="wrap">
    <h2><? _e('Payment Code settings page');?></h2>
    <form method="POST" action="">
    <table>
        <tr>
            <td><? _e('Subject Letter');?></td>
