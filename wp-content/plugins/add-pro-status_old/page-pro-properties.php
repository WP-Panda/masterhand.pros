...
<div class="container-fluid">
    ...
    <div class="row mb-2">
        <div class="col">
            <div class="collapseTitle" data-toggle="collapse" href="#statusListCollapse" aria-expanded="false" aria-controls="statusListCollapse">
                <h5>Statuses</h5>
            </div>
    ...
    <div class="row mb-2">
        <div class="col">
            <div class="collapseTitle" data-toggle="collapse" href="#propertyListCollapse" aria-expanded="false" aria-controls="propertyListCollapse">
                <h5>Properties</h5>
            </div>
    ...
    <div class="row mb-2">
        <div class="col">
            <div class="collapseTitle" data-toggle="collapse" href="#optionListCollapse" aria-expanded="false" aria-controls="optionListCollapse">
                <h5>Options</h5>
            </div>
            <div class="collapse multi-collapse" id="optionListCollapse">
                ...
                <div class="add-btn">
                    <input type="submit" name="submit" class="btn btn-primary" value="Edit options" onclick="modalWindow.show('modal_form_option')">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row mb-2">
        <div class="col">
            <div class="collapseTitle" data-toggle="collapse" href="#totalListCollapse" aria-expanded="false" aria-controls="totalListCollapse">
                <h5>Total</h5>
            </div>
...
//                            else !empty($item['option_value']) ? $item['property_name'].' '.$item['option_value'] : $item['property_name'];
                                            ...
                                            if ($value == 'id') { ?>
                                                ...
                                                <div class="add-btn">
                                                    <input type="submit" name="submit" class="btn btn-primary" value="Add status" onclick="modalWindow.show('modal_form_status')">
                                                </div>
                                            <?php } else { ?>
                                                <div class="add-btn">
                                                    <input type="submit" name="submit" class="btn btn-primary" value="Edit" onclick="modalWindow.show('modal_form_status', <?= $value ?>, 'status')">
                                                </div>
                                            <?php }
                                        } ?>
                                    </td>
    ...
    <form id="property" action="<?= $path ?>" method="post">
        <div class="name_property">
            <label style="display: block;">Type:
                <label for='type_str' style="padding-left: 15px;">String
                    <input type="radio" name="type" id="type_str" value="1">
                </label>
...
<div id="modal_form_option" class="simple-little-table" name="modal_form"><!-- Сaмo oкнo -->
    ...
    <form id="option" action="<?= $path ?>" method="post">
        <div class="name_option">
            <?php foreach ($options as $item) { ?>
                <label for='currency'>Currency <input type="text" name="currency" id="currency" placeholder="" value="<?= $item['option_value'] ?>"></label>
            <?php } ?>
        </div>
        <div>
            <input type="submit" name="submit" value="Save">
