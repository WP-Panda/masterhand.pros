...
if (!class_exists('AE_Stripe_Update') && class_exists('AE_Plugin_Updater') ){
	class AE_Stripe_Update extends AE_Plugin_Updater{
		...
		public function __construct(){
			...
			$this->update_path 		= 'http://update.enginethemes.com/?do=product-update&product=ae_stripe&type=plugin';
			parent::__construct();
		}
	}
