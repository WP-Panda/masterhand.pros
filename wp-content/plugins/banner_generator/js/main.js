            ...
            o.a.toPng(t).then((function (t) {
                jQuery.ajax({
                    ...
                    if (document.body.classList.remove("processing"), "error" == e) alert("Error! No save image"); else {
                        ...
                        t[0].src = "/wp-content/plugins/banner_generator/cache/" + e, document.getElementsByClassName("str_link")[0].textContent = t[0].src, document.querySelectorAll(".sharing .addtoany_list")[0].dataset.a2aUrl = t[0].src, document.querySelectorAll(".sharing .addtoany_list")[0].dataset.a2aTitle = "Banner", jQuery("#modal_banner").modal("show")
                    }
                }))
            }))
