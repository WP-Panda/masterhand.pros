...
function get_vars_for_poster()
{
    ...
    } else $varsTpl['skills'][] = 'No skills selected';
    ...
    } else $varsTpl['category'][] = 'No categories selected';
...
{
    if (!empty($_POST) && !empty($_POST['action']) && $_POST['action'] == 'generate_poster' && empty($_POST['template'])) exit;
...
{
    if (!empty($_POST) && !empty($_POST['action']) && $_POST['action'] == 'delete_cache_poster' && empty($_POST['template'])) exit;
